EXTER  object   fLbye   (int exitc) ; 
EXTER  object   fLquit   (int exitc) ; 
EXTER  object   fLexit   (int exitc) ; 
...
EXTER  object   fSallocate   (object type,int npages,...) ; 
EXTER  object   fSallocate_sgc   (object type,int min,int max,int free_percent) ; 
EXTER  object   fSallocate_growth   
      (object type,int min,int max,int percent,int percent_free) ; 
EXTER  object   fSallocate_contiguous_pages   (int npages,...) ; 
EXTER  object   fSallocated_contiguous_pages   (void) ; 
EXTER  object   fSmaximum_contiguous_pages   (void) ; 
EXTER  object   fSallocate_relocatable_pages   (int npages,...) ; 
EXTER  object   fSallocated_relocatable_pages   (void) ; 
EXTER  object   fSget_hole_size   (void) ; 
EXTER  object   fSset_hole_size   (int npages,...) ; 
...
EXTER  object   fSset_gmp_allocate_relocatable   
      (object flag) ; 
EXTER  object   fSallocate_bigger_fixnum_range   (int min,int max) ; 
...
EXTER  object   fLnth   (int index,object list) ; 
...
EXTER object  sLbit ; 
EXTER   object    fLaref   (object x, int i, ...) ; 
EXTER   object    fLsvref   (object x, unsigned int i) ; 
EXTER   object    fLrow_major_aref   (object x, int i) ; 
EXTER   object    fSaset1   (object x, int i,object val) ; 
EXTER   object    fSaset   (object x,int i,object y, ...) ; 
EXTER   object    fSsvset   (object x,int i,object val) ; 
EXTER  object   fSmake_vector1   (int n,int elt_type,object staticp,...) ; 
...
EXTER  object   fSmake_array1   
      (int elt_type,object staticp,object initial_element,object displaced_to, int displaced_index_offset,
       object dimensions) ; 
EXTER  object   fScopy_array_portion   (object x,object y,int i1,int i2,object n1o) ; 
EXTER  object   fSfill_pointer_set   (object x,int i) ; 
...
EXTER  object   fLarray_dimension   (object x,int i) ; 
...
EXTER  object   fSmatch_beginning   (int i) ; 
EXTER  object   fSmatch_end   (int i) ; 
...
EXTER  object   sSsignal_safety_required   (int signo,int safety) ; 
EXTER  object   fSallow_signal   (int n) ; 
...
EXTER  object   fSopen_named_socket   (int port) ; 
EXTER  object   fSclose_fd   (int fd) ; 
...
EXTER  object   fScheck_fd_for_input   (int fd,int timeout) ; 
EXTER  object   fSclear_connection   (int fd) ; 
EXTER  object   fSconnection_state_fd   (object sfd) ; 
EXTER  object   fSour_write   (object sfd,object buffer,int nbytes) ; 
EXTER  object   fSour_read_with_offset   (object fd,object buffer,int offset,int nbytes,int timeout) ; 
EXTER  object   fSprint_to_string1   (object str,object x,object the_code) ; 
EXTER  object   fSset_sigio_for_fd   (int fd) ; 
EXTER  object   fSreset_string_input_stream   (object strm,object string,int start,int end) ; 
EXTER  object   fScheck_state_input   (object osfd,int timeout) ; 
