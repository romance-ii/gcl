...
EXTER  object   fLhash_table_size (); 
...
EXTER  object   fLget_internal_real_time (); 
EXTER object  sSAdefault_time_zoneA ; 
EXTER  object   fSgetpid (); 
...
EXTER  object   sSsignal_safety_required (); 
EXTER  object   fSallow_signal (); 
...
EXTER  object   fScheck_fd_for_input (); 
EXTER  object   fSclear_connection (); 
EXTER  object   fSconnection_state_fd (); 
EXTER  object   fSour_write (); 
EXTER  object   fSour_read_with_offset (); 
EXTER  object   fSprint_to_string1 (); 
EXTER  object   fSset_sigio_for_fd (); 
EXTER  object   fSreset_string_input_stream (); 
EXTER  object   fScheck_state_input (); 
EXTER  object   fSclear_connection_state (); 
EXTER  object   fSgetpeername (); 
EXTER  object   fSgetsockname (); 
EXTER  object   fSset_blocking (); 
