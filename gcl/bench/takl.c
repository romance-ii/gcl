...
/*	local entry for function LISTN	*/
...
TTL:;
	...
	V4= (*(LnkLI3))((fixnum)(V2)-((fixnum)1));
	{object V5 = make_cons(V3,/* INLINE-ARGS */V4);
	VMR1(V5)}
	goto T2;
T2:;
	{object V6 = Cnil;
...
/*	local entry for function MAS	*/

static object LI2(V10,V11,V12)

register object V10;register object V11;register object V12;
{	 VMB2 VMS2 VMV2
	goto TTL;
TTL:;
	if(((*(LnkLI4))((V11),(V10)))!=Cnil){
	goto T5;}
	{object V13 = (V12);
	VMR2(V13)}
	goto T5;
T5:;
	{object V14;
	V14= (*(LnkLI5))(CMPcdr((V10)),(V11),(V12));
	{object V15;
	V15= (*(LnkLI5))(CMPcdr((V11)),(V12),(V10));
	V12= (*(LnkLI5))(CMPcdr((V12)),(V10),(V11));
	V11= (V15);
	V10= (V14);}}
	goto TTL;
	return Cnil;
}
/*	local entry for function SHORTERP	*/

static object LI3(V18,V19)

object V18;object V19;
{	 VMB3 VMS3 VMV3
	goto TTL;
TTL:;
	if((V19)==Cnil){
...
/*	local entry for function TESTTAKL	*/
...
{	 VMB4 VMS4 VMV4
	goto TTL;
TTL:;
	{object V22 = (*(LnkLI5))((VV[0]->s.s_dbind),(VV[1]->s.s_dbind),(VV[2]->s.s_dbind));
	VMR4(V22)}
	return Cnil;
}
static object  LnkTLI5(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[5],0,(void **)(void *)&LnkLI5,3,first,ap);va_end(ap);return V1;} /* MAS */
static object  LnkTLI4(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[4],0,(void **)(void *)&LnkLI4,2,first,ap);va_end(ap);return V1;} /* SHORTERP */
static object  LnkTLI3(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[3],0,(void **)(void *)&LnkLI3,4097,first,ap);va_end(ap);return V1;} /* LISTN */
