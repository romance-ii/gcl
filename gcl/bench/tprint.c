...
/*	local entry for function TPRINT-INIT	*/
...
T8:;
	...
	goto T5;
T5:;
	{object V9 = (*(LnkLI1))(fix((V4)),fix((V5)),(V7));
	VMR1(V9)}}
	base[0]=base[0];
	return Cnil;
}
/*	local entry for function TPRINT-INIT-AUX	*/

static object LI2(V13,V14,V15)

register long V13;register long V14;register object V15;
{	 VMB2 VMS2 VMV2
	goto TTL;
TTL:;
	if(!((V13)==((fixnum)0))){
...
T16:;
	{register object V18;
	register object V19;
	V18= CMPmake_fixnum(V14);
	V19= Cnil;
	goto T22;
T22:;
	if(!(number_compare((V18),small_fixnum(1))<0)){
	goto T23;}
	{object V20 = (V19);
	VMR2(V20)}
	goto T23;
T23:;
	...
	{register object V23;
	V23= (*(LnkLI1))((fixnum)(V13)-((fixnum)1),V14,(V15));
	V19= make_cons((V23),(V19));}
	V18= number_minus((V18),small_fixnum(2));
	goto T22;}
	base[0]=base[0];
	return Cnil;
}
/*	local entry for function STANDARD-TPRINT-TEST	*/
...
{	 VMB3 VMS3 VMV3
	goto TTL;
TTL:;
	{object V24 = print((VV[0]->s.s_dbind),Cnil);
	VMR3(V24)}
	return Cnil;
}
/*	local entry for function TESTTPRINT	*/
...
{	 VMB4 VMS4 VMV4
	goto TTL;
TTL:;
	{object V25 = print((VV[0]->s.s_dbind),Cnil);
	VMR4(V25)}
	return Cnil;
}
static object  LnkTLI1(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[1],0,(void **)(void *)&LnkLI1,20483,first,ap);va_end(ap);return V1;} /* TPRINT-INIT-AUX */
