...
/*	local entry for function ADD-LEMMA	*/
...
TTL:;
	...
	if(!((CMPcar((V2)))==(VV[0]))){
	goto T2;}
	if(type_of(CMPcadr((V2)))!=t_cons){
	goto T2;}
	V3= CMPcar(CMPcadr((V2)));
	{object V5 =(CMPcar(CMPcadr((V2))))->s.s_plist;
	 object ind= VV[1];
	while(V5!=Cnil){
	if(V5->c.c_car==ind){
	V4= (V5->c.c_cdr->c.c_car);
	goto T8;
	}else V5=V5->c.c_cdr->c.c_cdr;}
	V4= Cnil;}
	goto T8;
T8:;
	V6= make_cons((V2),V4);
	{object V7 = sputprop(/* INLINE-ARGS */V3,VV[1],/* INLINE-ARGS */V6);
	VMR1(V7)}
	goto T2;
T2:;
	base[0]= VV[2];
...
/*	local entry for function ADD-LEMMA-LST	*/
...
TTL:;
	...
	goto T12;
T12:;
	(void)((*(LnkLI11))(CMPcar((V10))));
	V10= CMPcdr((V10));
	goto TTL;
	return Cnil;
}
/*	local entry for function APPLY-SUBST	*/

static object LI3(V14,V15)

object V14;register object V15;
{	 VMB3 VMS3 VMV3
	goto TTL;
TTL:;
...
T23:;
	...
	goto T21;}
	{object V19 = CMPcdr((VV[3]->s.s_dbind));
	VMR3(V19)}
	goto T21;
T21:;
	{object V20 = (V15);
...
T18:;
	V21= CMPcar((V15));
	V22= (*(LnkLI12))((V14),CMPcdr((V15)));
	{object V23 = make_cons(/* INLINE-ARGS */V21,/* INLINE-ARGS */V22);
	VMR3(V23)}
	return Cnil;
}
/*	local entry for function APPLY-SUBST-LST	*/
...
TTL:;
	...
	goto T38;
T38:;
	V29= (*(LnkLI13))((V26),CMPcar((V27)));
	V30= (*(LnkLI12))((V26),CMPcdr((V27)));
	{object V31 = make_cons(/* INLINE-ARGS */V29,/* INLINE-ARGS */V30);
	VMR4(V31)}
	return Cnil;
}
/*	local entry for function FALSEP	*/

static object LI5(V34,V35)

object V34;object V35;
{	 VMB5 VMS5 VMV5
	goto TTL;
TTL:;
	if(!(equal((V34),VV[4]))){
...
/*	local entry for function ONE-WAY-UNIFY	*/

static object LI6(V42,V43)
...
TTL:;
	(VV[5]->s.s_dbind)= Cnil;
	{object V44 = (*(LnkLI14))((V42),(V43));
	VMR6(V44)}
	return Cnil;
}
/*	local entry for function ONE-WAY-UNIFY1	*/

static object LI7(V47,V48)

register object V47;register object V48;
{	 VMB7 VMS7 VMV7
	goto TTL;
TTL:;
...
T50:;
	if(((VV[3]->s.s_dbind))==Cnil){
	goto T48;}
	{object V52 = (equal((V47),CMPcdr((VV[3]->s.s_dbind)))?Ct:Cnil);
	VMR7(V52)}
	goto T48;
T48:;
	V53= make_cons((V48),(V47));
	(VV[5]->s.s_dbind)= make_cons(/* INLINE-ARGS */V53,(VV[5]->s.s_dbind));
	{object V54 = Ct;
	VMR7(V54)}
	goto T45;
T45:;
	...
	goto T67;
T67:;
	if(!((CMPcar((V47)))==(CMPcar((V48))))){
	goto T70;}
	{object V56 = (*(LnkLI15))(CMPcdr((V47)),CMPcdr((V48)));
	VMR7(V56)}
	goto T70;
T70:;
	{object V57 = Cnil;
...
/*	local entry for function ONE-WAY-UNIFY1-&LST	*/

static object LI8(V60,V61)
...
TTL:;
	...
	goto T73;
T73:;
	if(((*(LnkLI14))(CMPcar((V60)),CMPcar((V61))))==Cnil){
	goto T76;}
	V60= CMPcdr((V60));
	V61= CMPcdr((V61));
	goto TTL;
...
/*	local entry for function REWRITE	*/

static object LI9(V65)
...
T82:;
	V67= CMPcar((V65));
	V68= (*(LnkLI17))(CMPcdr((V65)));
	V69= make_cons(/* INLINE-ARGS */V67,/* INLINE-ARGS */V68);
	{object V71 =(CMPcar((V65)))->s.s_plist;
	 object ind= VV[1];
	while(V71!=Cnil){
	if(V71->c.c_car==ind){
	...
	goto T84;
T84:;
	{object V72 = (*(LnkLI16))(/* INLINE-ARGS */V69,V70);
	VMR9(V72)}
	return Cnil;
}
/*	local entry for function REWRITE-ARGS	*/

static object LI10(V74)
...
TTL:;
	...
	goto T86;
T86:;
	V76= (*(LnkLI18))(CMPcar((V74)));
	V77= (*(LnkLI17))(CMPcdr((V74)));
	{object V78 = make_cons(/* INLINE-ARGS */V76,/* INLINE-ARGS */V77);
	VMR10(V78)}
	return Cnil;
}
/*	local entry for function REWRITE-WITH-LEMMAS	*/

static object LI11(V81,V82)
...
TTL:;
	...
	goto T89;
T89:;
	if(((*(LnkLI19))((V81),CMPcadr(CMPcar((V82)))))==Cnil){
	goto T92;}{object V84;
	V84= (VV[5]->s.s_dbind);
	V85= (*(LnkLI13))(V84,CMPcaddr(CMPcar((V82))));
	{object V86 = (*(LnkLI18))(/* INLINE-ARGS */V85);
	VMR11(V86)}}
	goto T92;
T92:;
	V82= CMPcdr((V82));
...
/*	local entry for function BOYER-SETUP	*/
...
{	 VMB12 VMS12 VMV12
	goto TTL;
TTL:;
	{object V87 = (*(LnkLI20))(VV[6]);
	VMR12(V87)}
	return Cnil;
}
/*	local entry for function TAUTOLOGYP	*/

static object LI13(V91,V92,V93)

register object V91;register object V92;register object V93;
{	 VMB13 VMS13 VMV13
	goto TTL;
TTL:;
	if(((*(LnkLI21))((V91),(V92)))==Cnil){
	goto T98;}
	{object V94 = Ct;
	VMR13(V94)}
	goto T98;
T98:;
	if(((*(LnkLI22))((V91),(V93)))==Cnil){
	goto T101;}
	{object V95 = Cnil;
	VMR13(V95)}
	goto T101;
T101:;
	if(!(type_of((V91))!=t_cons)){
	goto T104;}
	{object V96 = Cnil;
	VMR13(V96)}
	goto T104;
T104:;
	if(!((CMPcar((V91)))==(VV[7]))){
	goto T107;}
	if(((*(LnkLI21))(CMPcadr((V91)),(V92)))==Cnil){
	goto T110;}
	V91= CMPcaddr((V91));
	goto TTL;
	goto T110;
T110:;
	if(((*(LnkLI22))(CMPcadr((V91)),(V93)))==Cnil){
	goto T117;}
	V91= CMPcadddr((V91));
	goto TTL;
	goto T117;
T117:;
	V97= CMPcaddr((V91));
	V98= make_cons(CMPcadr((V91)),(V92));
	if(((*(LnkLI23))(/* INLINE-ARGS */V97,/* INLINE-ARGS */V98,(V93)))!=Cnil){
	goto T123;}
	{object V99 = Cnil;
	VMR13(V99)}
	goto T123;
...
/*	local entry for function TAUTP	*/

static object LI14(V103)
...
TTL:;
	V104= (*(LnkLI18))((V103));
	{object V105 = (*(LnkLI23))(/* INLINE-ARGS */V104,Cnil,Cnil);
	VMR14(V105)}
	return Cnil;
}
/*	local entry for function BOYER-TEST	*/
...
TTL:;
	...
	V106= Cnil;
	V107= Cnil;
	V107= (*(LnkLI13))(VV[8],VV[9]);
	V106= (*(LnkLI24))((V107));
	{object V108 = Cnil;
	VMR15(V108)}}
	return Cnil;
}
/*	local entry for function TRUEP	*/

static object LI16(V111,V112)
...
TTL:;
	...
	goto T133;
T133:;
	{register object x= (V111),V114= (V112);
	while(V114!=Cnil)
...
/*	local entry for function TESTBOYER	*/
...
static object  LnkTLI25(){return call_proc0(VV[25],0,(void **)(void *)&LnkLI25);} /* BOYER-TEST */
static object  LnkTLI24(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[24],0,(void **)(void *)&LnkLI24,1,first,ap);va_end(ap);return V1;} /* TAUTP */
static object  LnkTLI23(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[23],0,(void **)(void *)&LnkLI23,3,first,ap);va_end(ap);return V1;} /* TAUTOLOGYP */
static object  LnkTLI22(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[22],0,(void **)(void *)&LnkLI22,2,first,ap);va_end(ap);return V1;} /* FALSEP */
static object  LnkTLI21(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[21],0,(void **)(void *)&LnkLI21,2,first,ap);va_end(ap);return V1;} /* TRUEP */
static object  LnkTLI20(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[20],0,(void **)(void *)&LnkLI20,1,first,ap);va_end(ap);return V1;} /* ADD-LEMMA-LST */
static object  LnkTLI19(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[19],0,(void **)(void *)&LnkLI19,2,first,ap);va_end(ap);return V1;} /* ONE-WAY-UNIFY */
static object  LnkTLI18(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[18],0,(void **)(void *)&LnkLI18,1,first,ap);va_end(ap);return V1;} /* REWRITE */
static object  LnkTLI17(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[17],0,(void **)(void *)&LnkLI17,1,first,ap);va_end(ap);return V1;} /* REWRITE-ARGS */
static object  LnkTLI16(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[16],0,(void **)(void *)&LnkLI16,2,first,ap);va_end(ap);return V1;} /* REWRITE-WITH-LEMMAS */
static object  LnkTLI15(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[15],0,(void **)(void *)&LnkLI15,2,first,ap);va_end(ap);return V1;} /* ONE-WAY-UNIFY1-&LST */
static object  LnkTLI14(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[14],0,(void **)(void *)&LnkLI14,2,first,ap);va_end(ap);return V1;} /* ONE-WAY-UNIFY1 */
static object  LnkTLI13(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[13],0,(void **)(void *)&LnkLI13,2,first,ap);va_end(ap);return V1;} /* APPLY-SUBST */
static object  LnkTLI12(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[12],0,(void **)(void *)&LnkLI12,2,first,ap);va_end(ap);return V1;} /* APPLY-SUBST-LST */
static object  LnkTLI11(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[11],0,(void **)(void *)&LnkLI11,1,first,ap);va_end(ap);return V1;} /* ADD-LEMMA */
