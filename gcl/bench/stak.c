...
/*	local entry for function STAK-AUX	*/
...
{	 VMB2 VMS2 VMV2
	...
	goto TTL;
TTL:;
	if((fix((VV[1]->s.s_dbind)))<(fix((VV[0]->s.s_dbind)))){
	goto T2;}
	{object V8 = (VV[2]->s.s_dbind);
	VMR2(V8)}
	goto T2;
T2:;
	base[3]= CMPmake_fixnum((long)(fix((VV[0]->s.s_dbind)))-((fixnum)1));
	...
	bds_unwind1;
	bds_unwind1;
	base[3]= CMPmake_fixnum((long)(fix((VV[1]->s.s_dbind)))-((fixnum)1));
	base[5]= (VV[0]->s.s_dbind);
	bds_bind(VV[0],base[3]);
	bds_bind(VV[1],(VV[2]->s.s_dbind));
	bds_bind(VV[2],base[5]);
	base[1]= (*(LnkLI3))();
	bds_unwind1;
	bds_unwind1;
	bds_unwind1;
	base[3]= CMPmake_fixnum((long)(fix((VV[2]->s.s_dbind)))-((fixnum)1));
	base[4]= (VV[0]->s.s_dbind);
	base[5]= (VV[1]->s.s_dbind);
	bds_bind(VV[0],base[3]);
	bds_bind(VV[1],base[4]);
	bds_bind(VV[2],base[5]);
	base[2]= (*(LnkLI3))();
	bds_unwind1;
	bds_unwind1;
...
/*	local entry for function TESTSTAK	*/
...
{	 VMB3 VMS3 VMV3
	goto TTL;
TTL:;
	{object V10 = (*(LnkLI4))(small_fixnum(18),small_fixnum(12),small_fixnum(6));
	VMR3(V10)}
	return Cnil;
}
static object  LnkTLI4(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[4],0,(void **)(void *)&LnkLI4,3,first,ap);va_end(ap);return V1;} /* STAK */
static object  LnkTLI3(){return call_proc0(VV[3],0,(void **)(void *)&LnkLI3);} /* STAK-AUX */
