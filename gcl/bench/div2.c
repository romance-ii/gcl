...
/*	local entry for function CREATE-N	*/
...
/*	local entry for function ITERATIVE-DIV2	*/
...
T16:;
	...
	{register object V13;
	V13= CMPcar((V9));
	V10= make_cons((V13),(V10));}
	V9= (V12);}
	goto T15;}
	base[0]=base[0];
	return Cnil;
}
/*	local entry for function RECURSIVE-DIV2	*/
...
T27:;
	V17= CMPcar((V15));
	V18= (*(LnkLI1))(CMPcddr((V15)));
	{object V19 = make_cons(/* INLINE-ARGS */V17,/* INLINE-ARGS */V18);
	VMR3(V19)}
	return Cnil;
}
/*	local entry for function TEST-1	*/
...
/*	local entry for function TEST-2	*/

static object LI5(V25)
...
T46:;
	...
	(void)((*(LnkLI1))((V25)));
	(void)((*(LnkLI1))((V25)));
	V26= (fixnum)(V26)-((fixnum)1);
	goto T45;}
	return Cnil;
}
/*	local entry for function TESTDIV2	*/
...
/*	local entry for function TESTDIV2-ITER	*/
...
{	 VMB7 VMS7 VMV7
	goto TTL;
TTL:;
	{object V29 = (*(LnkLI5))((VV[0]->s.s_dbind));
	VMR7(V29)}
	return Cnil;
}
/*	local entry for function TESTDIV2-RECUR	*/
...
{	 VMB8 VMS8 VMV8
	goto TTL;
TTL:;
	{object V30 = (*(LnkLI6))((VV[0]->s.s_dbind));
	VMR8(V30)}
	return Cnil;
}
static object  LnkTLI6(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[6],0,(void **)(void *)&LnkLI6,1,first,ap);va_end(ap);return V1;} /* TEST-2 */
static object  LnkTLI5(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[5],0,(void **)(void *)&LnkLI5,1,first,ap);va_end(ap);return V1;} /* TEST-1 */
static object  LnkTLI4(){return call_proc0(VV[4],0,(void **)(void *)&LnkLI4);} /* TESTDIV2-RECUR */
static object  LnkTLI3(){return call_proc0(VV[3],0,(void **)(void *)&LnkLI3);} /* TESTDIV2-ITER */
static object  LnkTLI2(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[2],0,(void **)(void *)&LnkLI2,1,first,ap);va_end(ap);return V1;} /* ITERATIVE-DIV2 */
static object  LnkTLI1(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[1],0,(void **)(void *)&LnkLI1,1,first,ap);va_end(ap);return V1;} /* RECURSIVE-DIV2 */
