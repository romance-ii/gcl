...
static object LI4(V40,V41,V42)

register object V40;object V41;register object V42;
{	 VMB4 VMS4 VMV4
	goto TTL;
TTL:;
	if(((V40))!=Cnil){
...
T124:;
	...
	V51= (fixnum)0;
	V52 = V51;
	V49= code_char(((unsigned char *)((V50))->v.v_self)[V52]);}
	if(type_of((V49))==t_character){
	goto T143;}
	goto T138;
	goto T143;
T143:;
	if(!(((fixnum)(63))==((fixnum)(char_code((V49)))))){
	goto T138;}}
	{object V53;
	{register object x= CMPcar((V40)),V54= (V42);
	while(V54!=Cnil)
	if(eql(x,V54->c.c_car->c.c_car) &&V54->c.c_car != Cnil){
	V53= (V54->c.c_car);
	goto T145;
...
T147:;
	...
	{object V56;
	V56= CMPcdr((V41));
	V57= make_cons(CMPcar((V40)),CMPcar((V41)));
	V42= make_cons(/* INLINE-ARGS */V57,(V42));
	V41= (V56);
	V40= (V55);}}
	goto TTL;}
	goto T138;
T138:;
	...
	V60= (fixnum)0;
	V61 = V60;
	V58= code_char(((unsigned char *)((V59))->v.v_self)[V61]);}
	if(type_of((V58))==t_character){
	goto T163;}
	goto T158;
	goto T163;
T163:;
	if(!(((fixnum)(42))==((fixnum)(char_code((V58)))))){
	goto T158;}}
	{object V62;
	{register object x= CMPcar((V40)),V63= (V42);
	while(V63!=Cnil)
	if(eql(x,V63->c.c_car->c.c_car) &&V63->c.c_car != Cnil){
	V62= (V63->c.c_car);
	goto T165;
...
T165:;
	if(((V62))==Cnil){
	goto T167;}
	V40= append(CMPcdr((V62)),CMPcdr((V40)));
	goto TTL;
	goto T167;
T167:;
	{register object V64;
...
T176:;
	V68= CMPcdr((V40));
	V69= make_cons(CMPcar((V40)),(V64));
	V70= make_cons(/* INLINE-ARGS */V69,(V42));
	if(((*(LnkLI9))(/* INLINE-ARGS */V68,(V66),/* INLINE-ARGS */V70))==Cnil){
	goto T180;}
	{object V71 = Ct;
	VMR4(V71)}
	goto T180;
T180:;
	V72= make_cons(CMPcar((V66)),Cnil);
	V64= nconc((V64),/* INLINE-ARGS */V72);
	V65= CMPcdr((V65));
	V66= CMPcdr((V66));
	goto T175;}}
	goto T158;
...
{	 VMB5 VMS5 VMV5
	goto TTL;
TTL:;
	V76= (*(LnkLI12))((fixnum)100,(fixnum)10,(fixnum)4,VV[6]);
	V77= (*(LnkLI11))(/* INLINE-ARGS */V76);
	{object V78 = (*(LnkLI10))(/* INLINE-ARGS */V77,VV[7]);
	VMR5(V78)}
	return Cnil;
}
/*	local entry for function INVESTIGATE	*/

static object LI6(V81,V82)
...
T205:;
	{register object V86;
	{object V87 =(CMPcar((V83)))->s.s_plist;
	 object ind= VV[1];
	while(V87!=Cnil){
	if(V87->c.c_car==ind){
	V86= (V87->c.c_cdr->c.c_car);
	goto T210;
...
T212:;
	...
	goto T213;
T213:;
	(void)((*(LnkLI9))(CMPcar((V85)),CMPcar((V86)),Cnil));
	V86= CMPcdr((V86));
	goto T212;}
	goto T209;
T209:;
