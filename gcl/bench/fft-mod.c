...
{register object *base=vs_base;
	...
	V1=V1->c.c_cdr;
	base[3]= (V1->c.c_car);}
	V2= list(3,VV[0],VV[1],base[2]);
	base[4]= list(3,VV[0],VV[1],list(3,VV[2],/* INLINE-ARGS */V2,list(3,VV[0],VV[1],base[3])));
...
{register object *base=vs_base;
	...
	V3=V3->c.c_cdr;
	base[3]= (V3->c.c_car);}
	V4= list(3,VV[0],VV[1],base[2]);
	base[4]= list(3,VV[0],VV[1],list(3,VV[3],/* INLINE-ARGS */V4,list(3,VV[0],VV[1],base[3])));
	vs_top=(vs_base=base+4)+1;
	return;
}
/*	macro definition for FF-	*/
...
{register object *base=vs_base;
	...
	V5=V5->c.c_cdr;
	base[3]= (V5->c.c_car);}
	V6= list(3,VV[0],VV[1],base[2]);
	base[4]= list(3,VV[0],VV[1],list(3,VV[4],/* INLINE-ARGS */V6,list(3,VV[0],VV[1],base[3])));
	vs_top=(vs_base=base+4)+1;
	return;
}
/*	macro definition for FF	*/
...
{register object *base=vs_base;
	...
	V7=V7->c.c_cdr;
	base[3]= (V7->c.c_car);}
	V8= list(3,VV[0],VV[1],base[2]);
	base[4]= list(3,VV[0],VV[1],list(3,VV[5],/* INLINE-ARGS */V8,list(3,VV[0],VV[1],base[3])));
	vs_top=(vs_base=base+4)+1;
	return;
}
/*	local entry for function FFT	*/

static object LI5(V11,V12)

object V11;object V12;
{	 VMB5 VMS5 VMV5
	goto TTL;
TTL:;
	{register object V13;
	...
	V17= (fixnum)0;
	V18= (fixnum)0;
	V19= (fixnum)((fixnum)((V13))->v.v_dim)-((fixnum)1);
	V20= (fixnum)({fixnum _t=(V19)/((fixnum)2);_t=((V19)<=0 && ((fixnum)2)<=0) || ((V19)>=0 && ((fixnum)2)>=0) || (((fixnum)2)*_t==(V19)) ? _t : _t-1;
	(void)(((V19)-_t*((fixnum)2))); _t;});
	V21= (fixnum)0;
	V22= (fixnum)0;
	V23= (fixnum)0;
	V24=     0.    ;
...
T22:;
	if((V19)==((fixnum)(1<<(V18)))){
	goto T29;}
	princ_str("error ... array size not a power of two.",Cnil);
	vs_base=vs_top;
	Lread();
	vs_top=sup;
	{object V30 = terpri(Cnil);
	VMR5(V30)}
	goto T29;
T29:;
	V16= (fixnum)1;
...
T20:;
	...
	V31= V16;
	V32 = V31;
	V28= ((double *)((V13))->v.v_self)[V32];}
	{long V33;
	V33= V16;
	V34 = V33;
	V29= ((double *)((V14))->v.v_self)[V34];}
	{long V35;
	V35= V16;
	V36 = V35;
	{long V38;
	V38= V15;
	V39 = V38;
	V37= ((double *)((V13))->v.v_self)[V39];}
	(void)(((double *)((V13))->v.v_self)[V36]=V37);}
	{long V40;
	V40= V16;
	V41 = V40;
	{long V43;
	V43= V15;
	V44 = V43;
	V42= ((double *)((V14))->v.v_self)[V44];}
	(void)(((double *)((V14))->v.v_self)[V41]=V42);}
	{long V45;
	V45= V15;
	V46 = V45;
	(void)(((double *)((V13))->v.v_self)[V46]=V28);}
	{long V47;
	V47= V15;
	V48 = V47;
	(void)(((double *)((V14))->v.v_self)[V48]=V29);}
	goto T37;
T37:;
	V17= V20;
	goto T21;
T21:;
	...
	goto T58;}
	V16= (fixnum)(V16)-(V17);
	V17= (fixnum)(V17)/((fixnum)2);
	goto T21;
	goto T58;
T58:;
	V16= (fixnum)(V16)+(V17);
	V15= (fixnum)(V15)+((fixnum)1);
	if(!((V15)<(V19))){
	goto T69;}
	goto T20;
	goto T69;
...
T76:;
	V21= (fixnum)(1<<(V49));
	V22= (fixnum)({fixnum _t=(V21)/((fixnum)2);_t=((V21)<=0 && ((fixnum)2)<=0) || ((V21)>=0 && ((fixnum)2)>=0) || (((fixnum)2)*_t==(V21)) ? _t : _t-1;
	(void)(((V21)-_t*((fixnum)2))); _t;});
	V24=     1.    ;
	V25=     0.    ;{object V50;
	V50= (VV[8]->s.s_dbind);
	V26= cos((double)(lf(V50))/(double)(((longfloat)(V22))));}{object V51;
	V51= (VV[8]->s.s_dbind);
	V27= sin((double)(lf(V51))/(double)(((longfloat)(V22))));}
	{long V52;
	V52= (fixnum)1;
	goto T95;
T95:;
...
T104:;
	...
	V55= V23;
	V56 = V55;
	V54= ((double *)((V13))->v.v_self)[V56];}
	{double V57= (double)(V54)*(double)(V24);
	{register long V59;
	V59= V23;
	V60 = V59;
	V58= ((double *)((V14))->v.v_self)[V60];}
	V28= (double)(/* INLINE-ARGS */V57)-(double)((double)(V58)*(double)(V25));}
	{register long V62;
	V62= V23;
	V63 = V62;
	V61= ((double *)((V13))->v.v_self)[V63];}
	{double V64= (double)(V61)*(double)(V25);
	{register long V66;
	V66= V23;
	V67 = V66;
	V65= ((double *)((V14))->v.v_self)[V67];}
	V29= (double)(/* INLINE-ARGS */V64)+(double)((double)(V65)*(double)(V24));}
	{register long V68;
	V68= V23;
	V69 = V68;
	{register long V71;
	V71= V53;
	V72 = V71;
	V70= ((double *)((V13))->v.v_self)[V72];}
	(void)(((double *)((V13))->v.v_self)[V69]=(double)(V70)-(double)(V28));}
	{register long V73;
	V73= V23;
	V74 = V73;
	{register long V76;
	V76= V53;
	V77 = V76;
	V75= ((double *)((V14))->v.v_self)[V77];}
	(void)(((double *)((V14))->v.v_self)[V74]=(double)(V75)-(double)(V29));}
	{register long V78;
	V78= V53;
	V79 = V78;
	{register long V81;
	V81= V53;
	V82 = V81;
	V80= ((double *)((V13))->v.v_self)[V82];}
	(void)(((double *)((V13))->v.v_self)[V79]=(double)(V80)+(double)(V28));}
	{register long V83;
	V83= V53;
	V84 = V83;
	{register long V86;
	V86= V53;
	V87 = V86;
	V85= ((double *)((V14))->v.v_self)[V87];}
	(void)(((double *)((V14))->v.v_self)[V84]=(double)(V85)+(double)(V29));}
	V53= (fixnum)(V53)+(V21);
	goto T103;}
	goto T100;
T100:;
	V52= (fixnum)(V52)+((fixnum)1);
	goto T95;}
	goto T92;
T92:;
	V28= (double)((double)(V24)*(double)(V26))-(double)((double)(V25)*(double)(V27));
	V29= (double)((double)(V24)*(double)(V27))+(double)((double)(V25)*(double)(V26));
	V24= V28;
	V25= V29;
	V49= (fixnum)(V49)+((fixnum)1);
	goto T75;}
	goto T72;
T72:;
	{object V88 = Ct;
...
/*	local entry for function FFT-BENCH	*/
...
T158:;
	...
	goto T159;
T159:;
	(void)((*(LnkLI20))((VV[9]->s.s_dbind),(VV[10]->s.s_dbind)));
	V90= (fixnum)(V90)+((fixnum)1);
	goto T158;}
	return Cnil;
}
/*	local entry for function TESTFFT	*/
...
/*	local entry for function CLEAR-FFT	*/
...
T171:;
	...
	V94= V93;
	V95 = V94;
	(void)(((double *)((VV[9]->s.s_dbind))->v.v_self)[V95]=    0.    );}
	{register long V96;
	V96= V93;
	V97 = V96;
	(void)(((double *)((VV[10]->s.s_dbind))->v.v_self)[V97]=    0.    );}
	V93= (fixnum)(V93)+((fixnum)1);
	goto T170;}
	goto T167;
T167:;
...
/*	function definition for SETUP-FFT-COMPONENT	*/
...
T182:;
	...
	goto T183;
T183:;
	{register double V101;
	register double V102;
	register double V103;
	V101= (double)(    2.    )*(double)((double)(3.1415926535897931    )*(double)(lf((V99))));
	V102= cos((double)(   0.5    )*(double)((double)(3.1415926535897931    )*(double)(lf((V100)))));
	V103= sin((double)(   0.5    )*(double)((double)(3.1415926535897931    )*(double)(lf((V100)))));
	{register long V104;
	V104= (fixnum)0;
	goto T191;
T191:;
...
T192:;
	...
	V106 = make_longfloat(V101);
	base[3]= CMPmake_fixnum(V104);
	base[4]= VV[15];
	vs_top=(vs_base=base+3)+2;
	Ldivide();
	vs_top=sup;
	V107= vs_base[0];
	base[2]= number_times(V106,V107);
	...
	V109= V104;
	{object V111;
	V112 = make_longfloat(V102);
	base[4]= number_times(V112,(V105));
	base[5]= VV[6];
	...
	V114= V109;
	V115 = V114;
	V113= make_longfloat(((double *)((V108))->v.v_self)[V115]);}
	V110= number_plus(V113,(V111));}
	{long V116;
	V116= V109;
	V117 = V116;
	(void)(((double *)((V108))->v.v_self)[V117]=lf((V110)));}}
	{object V118;
	register long V119;
	object V120;
	V118= (VV[10]->s.s_dbind);
	V119= V104;
	{object V121;
	V122 = make_longfloat(V103);
	base[4]= number_times(V122,(V105));
	base[5]= VV[6];
	vs_top=(vs_base=base+4)+2;
	Lfloat();
	vs_top=sup;
	...
	V124= V119;
	V125 = V124;
	V123= make_longfloat(((double *)((V118))->v.v_self)[V125]);}
	V120= number_plus(V123,(V121));}
	{long V126;
	V126= V119;
	V127 = V126;
	(void)(((double *)((V118))->v.v_self)[V127]=lf((V120)));}}}
...
/*	local entry for function PRINT-FFT	*/
...
T227:;
	...
	goto T228;
T228:;
	{register double V129;
	register double V130;
	{register long V131;
	V131= V128;
	V132 = V131;
	V129= ((double *)((VV[9]->s.s_dbind))->v.v_self)[V132];}
	{register long V133;
	V133= V128;
	V134 = V133;
	V130= ((double *)((VV[10]->s.s_dbind))->v.v_self)[V134];}
	V135 = make_longfloat(V129);
	V136= (*(LnkLI22))(V135);
	if(!(number_compare(/* INLINE-ARGS */V136,(VV[16]->s.s_dbind))<0)){
	goto T237;}
	V137 = make_longfloat(V130);
	V138= (*(LnkLI22))(V137);
	if(number_compare(/* INLINE-ARGS */V138,(VV[16]->s.s_dbind))<0){
	goto T232;}
	goto T237;
T237:;
	base[0]= Ct;
	base[1]= VV[17];
	base[2]= CMPmake_fixnum(V128);
	base[3]= make_longfloat(V129);
	base[4]= make_longfloat(V130);
	vs_top=(vs_base=base+0)+5;
	Lformat();
	vs_top=sup;}
	goto T232;
T232:;
	V128= (fixnum)(V128)+((fixnum)1);
	goto T227;}
	goto T224;
T224:;
	vs_base=vs_top=base+0;
...
/*	local entry for function SHOW-FFT	*/
...
static object  LnkTLI25(){return call_proc0(VV[25],0,(void **)(void *)&LnkLI25);} /* PRINT-FFT */
static void LnkT24(){ call_or_link(VV[24],0,(void **)(void *)&Lnk24);} /* SETUP-FFT-COMPONENT */
static object  LnkTLI23(){return call_proc0(VV[23],0,(void **)(void *)&LnkLI23);} /* CLEAR-FFT */
static object  LnkTLI22(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[22],0,(void **)(void *)&LnkLI22,1,first,ap);va_end(ap);return V1;} /* ABS */
static object  LnkTLI21(){return call_proc0(VV[21],0,(void **)(void *)&LnkLI21);} /* FFT-BENCH */
static object  LnkTLI20(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[20],0,(void **)(void *)&LnkLI20,2,first,ap);va_end(ap);return V1;} /* FFT */
static object  LnkTLI19(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[19],0,(void **)(void *)&LnkLI19,16642,first,ap);va_end(ap);return V1;} /* CMP-ARRAY-DIMENSION */
