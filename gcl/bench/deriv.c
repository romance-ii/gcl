...
/*	local entry for function DERIV-AUX	*/
...
/*	local entry for function DERIV	*/
...
TTL:;
	...
	if(!(((V6))==(VV[1]))){
	goto T5;}
	{object V7 = small_fixnum(1);
	VMR2(V7)}
	goto T5;
T5:;
	{object V8 = small_fixnum(0);
	VMR2(V8)}
	goto T2;
T2:;
	if(!((CMPcar((V6)))==(VV[2]))){
	goto T8;}
	{object V10;
	object V11= CMPcdr((V6));
	if(V11==Cnil){
	V9= Cnil;
	goto T10;}
	base[0]=V10=MMcons(Cnil,Cnil);
	goto T11;
T11:;
	(V10->c.c_car)= (*(LnkLI11))((V11->c.c_car));
...
T8:;
	...
	goto T17;
T17:;
	(V14->c.c_car)= (*(LnkLI11))((V15->c.c_car));
...
T14:;
	...
	V17= Cnil;
	goto T22;}
	base[0]=V18=MMcons(Cnil,Cnil);
	goto T23;
T23:;
	(V18->c.c_car)= (*(LnkLI12))((V19->c.c_car));
	if((V19=MMcdr(V19))==Cnil){
	V17= base[0];
	goto T22;}
	V18=MMcdr(V18)=MMcons(Cnil,Cnil);
	goto T23;}
	goto T22;
T22:;
	{object V20 = list(3,VV[4],(V6),make_cons(VV[2],V17));
	VMR2(V20)}
	goto T20;
T20:;
	if(!((CMPcar((V6)))==(VV[0]))){
	goto T26;}
	V21= (*(LnkLI11))(CMPcadr((V6)));
	V22= list(3,VV[0],/* INLINE-ARGS */V21,CMPcaddr((V6)));
	V23= CMPcadr((V6));
	V24= CMPcaddr((V6));
	V25= CMPcaddr((V6));
	{object V26 = list(3,VV[3],/* INLINE-ARGS */V22,list(3,VV[0],/* INLINE-ARGS */V23,list(4,VV[4],/* INLINE-ARGS */V24,/* INLINE-ARGS */V25,(*(LnkLI11))(CMPcaddr((V6))))));
	VMR2(V26)}
	goto T26;
T26:;
	{object V27 = VV[5];
...
/*	local entry for function DERIV-RUN	*/
...
T31:;
	...
	(void)((*(LnkLI11))(VV[9]));
	(void)((*(LnkLI11))(VV[10]));
	V28= (fixnum)(V28)+((fixnum)1);
	goto T30;}
	return Cnil;
}
/*	local entry for function TESTDERIV	*/
...
static object  LnkTLI13(){return call_proc0(VV[13],0,(void **)(void *)&LnkLI13);} /* DERIV-RUN */
static object  LnkTLI12(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[12],0,(void **)(void *)&LnkLI12,1,first,ap);va_end(ap);return V1;} /* DERIV-AUX */
static object  LnkTLI11(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[11],0,(void **)(void *)&LnkLI11,1,first,ap);va_end(ap);return V1;} /* DERIV */
