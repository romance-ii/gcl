...
{register object *base=vs_base;
	...
	V1=V1->c.c_cdr;
	base[3]= (V1->c.c_car);}
	V2= list(3,VV[1],base[2],VV[2]);
	base[4]= list(3,VV[0],/* INLINE-ARGS */V2,list(3,VV[1],base[3],VV[3]));
...
{register object *base=vs_base;
	...
	base[2]= (V4->c.c_car);}
	V5= list(2,VV[6],base[2]);
	base[3]= list(3,VV[5],/* INLINE-ARGS */V5,list(2,VV[7],base[2]));
	vs_top=(vs_base=base+3)+1;
	return;
}
...
{register object *base=vs_base;
	...
	V7=V7->c.c_cdr;
	base[3]= (V7->c.c_car);}
	base[4]= list(3,VV[8],base[2],base[3]);
	vs_top=(vs_base=base+4)+1;
	return;
}
...
{register object *base=vs_base;
	...
	V8=V8->c.c_cdr;
	base[3]= (V8->c.c_car);}
	base[4]= list(3,VV[9],base[2],base[3]);
	vs_top=(vs_base=base+4)+1;
	return;
}
/*	local entry for function PCOEFADD	*/

static object LI7(V12,V13,V14)

object V12;object V13;object V14;
{	 VMB7 VMS7 VMV7
	goto TTL;
TTL:;
	if(!(({enum type _numberp=type_of((V13)); _numberp>=t_fixnum && _numberp <= t_complex;}))){
	goto T5;}
	if(!(number_compare(small_fixnum(0),(V13))==0)){
	goto T2;}
	goto T3;
	goto T5;
T5:;
...
T3:;
	...
	goto T2;
T2:;
	{object V16 = listA(3,(V12),(V13),(V14));
	VMR7(V16)}
	return Cnil;
}
/*	local entry for function PCPLUS	*/

static object LI8(V19,V20)

object V19;register object V20;
{	 VMB8 VMS8 VMV8
	goto TTL;
TTL:;
	if(!(type_of((V20))!=t_cons)){
	goto T8;}
	{object V21 = number_plus((V20),(V19));
	VMR8(V21)}
	goto T8;
T8:;
	V22= CMPcar((V20));
	V23= (*(LnkLI18))((V19),CMPcdr((V20)));
	{object V24 = (*(LnkLI17))(/* INLINE-ARGS */V22,/* INLINE-ARGS */V23);
	VMR8(V24)}
	return Cnil;
}
/*	local entry for function PCPLUS1	*/

static object LI9(V27,V28)

register object V27;register object V28;
{	 VMB9 VMS9 VMV9
	goto TTL;
TTL:;
	if(((V28))!=Cnil){
	goto T11;}
	if(!(({enum type _numberp=type_of((V27)); _numberp>=t_fixnum && _numberp <= t_complex;}))){
	goto T17;}
...
T15:;
	...
	goto T14;
T14:;
	{object V30 = list(2,small_fixnum(0),(V27));
	VMR9(V30)}
	goto T11;
T11:;
	{object V31= CMPcar((V28));
	if(!(({enum type _numberp=type_of(V31); _numberp>=t_fixnum && _numberp <= t_complex;}))){
	goto T23;}}
	if(!(number_compare(small_fixnum(0),CMPcar((V28)))==0)){
	goto T20;}
	goto T21;
	goto T23;
T23:;
	...
	goto T21;
T21:;
	V32= (*(LnkLI20))((V27),CMPcadr((V28)));
	{object V33 = (*(LnkLI19))(small_fixnum(0),/* INLINE-ARGS */V32,Cnil);
	VMR9(V33)}
	goto T20;
T20:;
	V34= CMPcar((V28));
	V35= CMPcadr((V28));
	{object V36 = listA(3,/* INLINE-ARGS */V34,/* INLINE-ARGS */V35,(*(LnkLI18))((V27),CMPcddr((V28))));
	VMR9(V36)}
	return Cnil;
}
/*	local entry for function PCTIMES	*/

static object LI10(V39,V40)

object V39;register object V40;
{	 VMB10 VMS10 VMV10
	goto TTL;
TTL:;
	if(!(type_of((V40))!=t_cons)){
	goto T26;}
	{object V41 = number_times((V39),(V40));
	VMR10(V41)}
	goto T26;
T26:;
	V42= CMPcar((V40));
	V43= (*(LnkLI21))((V39),CMPcdr((V40)));
	{object V44 = (*(LnkLI17))(/* INLINE-ARGS */V42,/* INLINE-ARGS */V43);
	VMR10(V44)}
	return Cnil;
}
/*	local entry for function PCTIMES1	*/

static object LI11(V47,V48)
...
T29:;
	V50= CMPcar((V48));
	V51= (*(LnkLI22))((V47),CMPcadr((V48)));
	V52= (*(LnkLI21))((V47),CMPcddr((V48)));
	{object V53 = (*(LnkLI19))(/* INLINE-ARGS */V50,/* INLINE-ARGS */V51,/* INLINE-ARGS */V52);
	VMR11(V53)}
	return Cnil;
}
/*	local entry for function PPLUS	*/

static object LI12(V56,V57)

register object V56;register object V57;
{	 VMB12 VMS12 VMV12
	goto TTL;
TTL:;
	if(!(type_of((V56))!=t_cons)){
	goto T32;}
	{object V58 = (*(LnkLI23))((V56),(V57));
	VMR12(V58)}
	goto T32;
T32:;
	if(!(type_of((V57))!=t_cons)){
	goto T35;}
	{object V59 = (*(LnkLI23))((V57),(V56));
	VMR12(V59)}
	goto T35;
T35:;
	if(!((CMPcar((V56)))==(CMPcar((V57))))){
	goto T38;}
	V60= CMPcar((V56));
	V61= (*(LnkLI24))(CMPcdr((V57)),CMPcdr((V56)));
	{object V62 = (*(LnkLI17))(/* INLINE-ARGS */V60,/* INLINE-ARGS */V61);
	VMR12(V62)}
	goto T38;
T38:;
	{object V64 =(CMPcar((V56)))->s.s_plist;
	 object ind= VV[10];
	while(V64!=Cnil){
	if(V64->c.c_car==ind){
	...
	goto T43;
T43:;
	{object V66 =(CMPcar((V57)))->s.s_plist;
	 object ind= VV[10];
	while(V66!=Cnil){
	if(V66->c.c_car==ind){
	V65= (V66->c.c_cdr->c.c_car);
	goto T44;
	}else V66=V66->c.c_cdr->c.c_cdr;}
	V65= Cnil;}
	goto T44;
T44:;
	if(!(number_compare(V63,V65)>0)){
	goto T41;}
	V67= CMPcar((V56));
	V68= (*(LnkLI18))((V57),CMPcdr((V56)));
	{object V69 = (*(LnkLI17))(/* INLINE-ARGS */V67,/* INLINE-ARGS */V68);
	VMR12(V69)}
	goto T41;
T41:;
	V70= CMPcar((V57));
	V71= (*(LnkLI18))((V56),CMPcdr((V57)));
	{object V72 = (*(LnkLI17))(/* INLINE-ARGS */V70,/* INLINE-ARGS */V71);
	VMR12(V72)}
	return Cnil;
}
/*	local entry for function PPLUS1	*/

static object LI13(V75,V76)

register object V75;register object V76;
{	 VMB13 VMS13 VMV13
	goto TTL;
TTL:;
	if(((V75))!=Cnil){
...
T46:;
	...
	goto T49;
T49:;
	if(!(number_compare(CMPcar((V75)),CMPcar((V76)))==0)){
	goto T52;}
	V79= CMPcar((V75));
	V80= (*(LnkLI20))(CMPcadr((V75)),CMPcadr((V76)));
	V81= (*(LnkLI24))(CMPcddr((V75)),CMPcddr((V76)));
	{object V82 = (*(LnkLI19))(/* INLINE-ARGS */V79,/* INLINE-ARGS */V80,/* INLINE-ARGS */V81);
	VMR13(V82)}
	goto T52;
T52:;
	if(!(number_compare(CMPcar((V75)),CMPcar((V76)))>0)){
	...
	V83= CMPcar((V75));
	V84= CMPcadr((V75));
	{object V85 = listA(3,/* INLINE-ARGS */V83,/* INLINE-ARGS */V84,(*(LnkLI24))(CMPcddr((V75)),(V76)));
	VMR13(V85)}
	goto T55;
T55:;
	V86= CMPcar((V76));
	V87= CMPcadr((V76));
	{object V88 = listA(3,/* INLINE-ARGS */V86,/* INLINE-ARGS */V87,(*(LnkLI24))((V75),CMPcddr((V76))));
	VMR13(V88)}
	return Cnil;
}
/*	local entry for function PSIMP	*/

static object LI14(V91,V92)

object V91;register object V92;
{	 VMB14 VMS14 VMV14
	goto TTL;
TTL:;
	if(((V92))!=Cnil){
	goto T58;}
	{object V93 = small_fixnum(0);
	VMR14(V93)}
	goto T58;
T58:;
	...
	goto T61;
T61:;
	if(!(number_compare(small_fixnum(0),CMPcar((V92)))==0)){
	goto T64;}
	{object V95 = CMPcadr((V92));
	VMR14(V95)}
	goto T64;
T64:;
	{object V96 = make_cons((V91),(V92));
	VMR14(V96)}
	return Cnil;
}
/*	local entry for function PTIMES	*/

static object LI15(V99,V100)

register object V99;register object V100;
{	 VMB15 VMS15 VMV15
	goto TTL;
TTL:;
	if(!(({enum type _numberp=type_of((V99)); _numberp>=t_fixnum && _numberp <= t_complex;}))){
	goto T71;}
	if(number_compare(small_fixnum(0),(V99))==0){
	goto T66;}
	goto T69;
	goto T71;
T71:;
	goto T69;
T69:;
	if(!(({enum type _numberp=type_of((V100)); _numberp>=t_fixnum && _numberp <= t_complex;}))){
	goto T75;}
	if(!(number_compare(small_fixnum(0),(V100))==0)){
	goto T67;}
	goto T73;
	goto T75;
T75:;
...
T73:;
	goto T66;
T66:;
	{object V101 = small_fixnum(0);
	VMR15(V101)}
	goto T67;
T67:;
	if(!(type_of((V99))!=t_cons)){
	goto T78;}
	{object V102 = (*(LnkLI25))((V99),(V100));
	VMR15(V102)}
	goto T78;
T78:;
	if(!(type_of((V100))!=t_cons)){
	goto T81;}
	{object V103 = (*(LnkLI25))((V100),(V99));
	VMR15(V103)}
	goto T81;
T81:;
	if(!((CMPcar((V99)))==(CMPcar((V100))))){
	goto T84;}
	V104= CMPcar((V99));
	V105= (*(LnkLI26))(CMPcdr((V99)),CMPcdr((V100)));
	{object V106 = (*(LnkLI17))(/* INLINE-ARGS */V104,/* INLINE-ARGS */V105);
	VMR15(V106)}
	goto T84;
T84:;
	{object V108 =(CMPcar((V99)))->s.s_plist;
	 object ind= VV[10];
	while(V108!=Cnil){
	if(V108->c.c_car==ind){
	V107= (V108->c.c_cdr->c.c_car);
	goto T89;
	}else V108=V108->c.c_cdr->c.c_cdr;}
	V107= Cnil;}
	goto T89;
T89:;
	{object V110 =(CMPcar((V100)))->s.s_plist;
	 object ind= VV[10];
	while(V110!=Cnil){
	if(V110->c.c_car==ind){
	...
	goto T90;
T90:;
	if(!(number_compare(V107,V109)>0)){
	goto T87;}
	V111= CMPcar((V99));
	V112= (*(LnkLI21))((V100),CMPcdr((V99)));
	{object V113 = (*(LnkLI17))(/* INLINE-ARGS */V111,/* INLINE-ARGS */V112);
	VMR15(V113)}
	goto T87;
T87:;
	V114= CMPcar((V100));
	V115= (*(LnkLI21))((V99),CMPcdr((V100)));
	{object V116 = (*(LnkLI17))(/* INLINE-ARGS */V114,/* INLINE-ARGS */V115);
	VMR15(V116)}
	return Cnil;
}
/*	local entry for function PTIMES1	*/

static object LI16(V119,V120)

register object V119;register object V120;
{	 VMB16 VMS16 VMV16
	bds_check;
	goto TTL;
TTL:;
	...
	bds_bind(VV[12],Cnil);
	bds_bind(VV[13],Cnil);
	(VV[12]->s.s_dbind)= (*(LnkLI27))((V120));
	(VV[13]->s.s_dbind)= (VV[12]->s.s_dbind);
	goto T92;
T92:;
	(VV[11]->s.s_dbind)= CMPcddr((VV[11]->s.s_dbind));
	if(((VV[11]->s.s_dbind))!=Cnil){
	goto T97;}
	{object V121 = (VV[12]->s.s_dbind);
	bds_unwind1;
	bds_unwind1;
	bds_unwind1;
	VMR16(V121)}
...
/*	local entry for function PTIMES2	*/

static object LI17(V123)
...
TTL:;
	...
	goto T103;
T103:;
	V125= number_plus(CMPcar((VV[11]->s.s_dbind)),CMPcar((V123)));
	V126= (*(LnkLI22))(CMPcadr((VV[11]->s.s_dbind)),CMPcadr((V123)));
	V127= (*(LnkLI27))(CMPcddr((V123)));
	{object V128 = (*(LnkLI19))(/* INLINE-ARGS */V125,/* INLINE-ARGS */V126,/* INLINE-ARGS */V127);
	VMR17(V128)}
	return Cnil;
}
/*	local entry for function PTIMES3	*/

static object LI18(V130)
...
T106:;
	...
	goto T112;
T112:;
	V131= number_plus(CMPcar((VV[11]->s.s_dbind)),CMPcar((V130)));
	V133= (*(LnkLI22))(CMPcadr((V130)),CMPcadr((VV[11]->s.s_dbind)));
	if(!(({enum type _numberp=type_of((V133)); _numberp>=t_fixnum && _numberp <= t_complex;}))){
	goto T123;}
	if(!(number_compare(small_fixnum(0),(V133))==0)){
	goto T120;}
	goto T121;
	goto T123;
T123:;
...
T120:;
	...
	goto T127;}
	if(!(number_compare((V131),CMPcar((VV[13]->s.s_dbind)))>0)){
	goto T128;}
	goto T127;
T127:;{object V135;
	V135= (VV[12]->s.s_dbind);
	V136= list(2,(V131),(V133));
	(VV[13]->s.s_dbind)= (*(LnkLI24))(V135,/* INLINE-ARGS */V136);}
	(VV[12]->s.s_dbind)= (VV[13]->s.s_dbind);
	V130= CMPcddr((V130));
	goto T106;
	goto T128;
T128:;
	if(!(number_compare((V131),CMPcar((VV[13]->s.s_dbind)))==0)){
	goto T107;}
	V133= (*(LnkLI20))((V133),CMPcadr((VV[13]->s.s_dbind)));
	if(!(({enum type _numberp=type_of((V133)); _numberp>=t_fixnum && _numberp <= t_complex;}))){
	goto T146;}
	if(!(number_compare(small_fixnum(0),(V133))==0)){
	goto T143;}
...
T146:;
	...
	goto T144;
T144:;
	base[0]= (VV[12]->s.s_dbind);
	base[1]= list(2,CMPcar((VV[13]->s.s_dbind)),CMPcadr((VV[13]->s.s_dbind)));
	vs_top=(vs_base=base+0)+2;
	(void) (*Lnk29)();
	vs_top=sup;
	(VV[13]->s.s_dbind)= vs_base[0];
	(VV[12]->s.s_dbind)= (VV[13]->s.s_dbind);
	goto T141;
	goto T143;
T143:;
	(CMPcdr((VV[13]->s.s_dbind)))->c.c_car = (V133);
	(void)(CMPcdr((VV[13]->s.s_dbind)));
	goto T141;
T141:;
	V130= CMPcddr((V130));
	goto T106;
	goto T107;
T107:;
	if((CMPcddr((VV[13]->s.s_dbind)))==Cnil){
	goto T154;}
	if(!(number_compare(CMPcaddr((VV[13]->s.s_dbind)),(V131))>0)){
	goto T154;}
	(VV[13]->s.s_dbind)= CMPcddr((VV[13]->s.s_dbind));
	goto T107;
	goto T154;
T154:;
	V132= CMPcdr((VV[13]->s.s_dbind));
	goto T108;
T108:;
	if((CMPcdr((V132)))==Cnil){
	goto T163;}
	if(!(number_compare(CMPcadr((V132)),(V131))<0)){
	goto T162;}
	goto T163;
T163:;
	V137= listA(3,(V131),(V133),CMPcdr((V132)));
	((V132))->c.c_cdr = /* INLINE-ARGS */V137;
	goto T109;
	goto T162;
T162:;
	V133= (*(LnkLI20))(CMPcaddr((V132)),(V133));
	if(!(({enum type _numberp=type_of((V133)); _numberp>=t_fixnum && _numberp <= t_complex;}))){
	goto T172;}
	V133= (*(LnkLI20))(CMPcaddr((V132)),(V133));
	if(!(number_compare(small_fixnum(0),(V133))==0)){
...
T172:;
	...
	goto T170;
T170:;
	((V132))->c.c_cdr = CMPcdddr((V132));
	goto T110;
	goto T169;
T169:;
	(CMPcddr((V132)))->c.c_car = (V133);
	(void)(CMPcddr((V132)));
	goto T109;
T109:;
	V132= CMPcddr((V132));
...
/*	local entry for function PEXPTSQ	*/

static object LI19(V141,V142)

register object V141;register object V142;
{	 VMB19 VMS19 VMV19
	goto TTL;
TTL:;
...
T197:;
	goto T203;
T203:;
	if(!(number_compare(small_fixnum(0),(V143))==0)){
	goto T204;}
	{object V145 = (V144);
	VMR19(V145)}
	goto T204;
T204:;
	V141= (*(LnkLI22))((V141),(V141));
	base[0]= (V143);
	vs_top=(vs_base=base+0)+1;
	Loddp();
	vs_top=sup;
...
/*	local entry for function STANDARD-FRPOLY-TEST1	*/
...
{	 VMB20 VMS20 VMV20
	goto TTL;
TTL:;
	(void)((*(LnkLI30))((VV[14]->s.s_dbind),small_fixnum(2)));
	(void)((*(LnkLI30))((VV[15]->s.s_dbind),small_fixnum(2)));
	(void)((*(LnkLI30))((VV[16]->s.s_dbind),small_fixnum(2)));
	{object V146 = Cnil;
	VMR20(V146)}
	return Cnil;
}
/*	local entry for function STANDARD-FRPOLY-TEST2	*/
...
{	 VMB21 VMS21 VMV21
	goto TTL;
TTL:;
	(void)((*(LnkLI30))((VV[14]->s.s_dbind),small_fixnum(5)));
	(void)((*(LnkLI30))((VV[15]->s.s_dbind),small_fixnum(5)));
	(void)((*(LnkLI30))((VV[16]->s.s_dbind),small_fixnum(5)));
	{object V147 = Cnil;
	VMR21(V147)}
	return Cnil;
}
/*	local entry for function STANDARD-FRPOLY-TEST3	*/
...
{	 VMB22 VMS22 VMV22
	goto TTL;
TTL:;
	(void)((*(LnkLI30))((VV[14]->s.s_dbind),small_fixnum(10)));
	(void)((*(LnkLI30))((VV[15]->s.s_dbind),small_fixnum(10)));
	(void)((*(LnkLI30))((VV[16]->s.s_dbind),small_fixnum(10)));
	{object V148 = Cnil;
	VMR22(V148)}
	return Cnil;
}
/*	local entry for function STANDARD-FRPOLY-TEST4	*/
...
{	 VMB23 VMS23 VMV23
	goto TTL;
TTL:;
	(void)((*(LnkLI30))((VV[14]->s.s_dbind),small_fixnum(15)));
	(void)((*(LnkLI30))((VV[15]->s.s_dbind),small_fixnum(15)));
	(void)((*(LnkLI30))((VV[16]->s.s_dbind),small_fixnum(15)));
	{object V149 = Cnil;
	VMR23(V149)}
	return Cnil;
}
/*	local entry for function TESTFRPOLY	*/
...
/*	local entry for function TESTFRPOLY-1	*/
...
/*	local entry for function TESTFRPOLY-2	*/
...
/*	local entry for function TESTFRPOLY-3	*/
...
/*	local entry for function TESTFRPOLY-4	*/
...
static object  LnkTLI38(){return call_proc0(VV[38],0,(void **)(void *)&LnkLI38);} /* STANDARD-FRPOLY-TEST4 */
static object  LnkTLI37(){return call_proc0(VV[37],0,(void **)(void *)&LnkLI37);} /* STANDARD-FRPOLY-TEST3 */
static object  LnkTLI36(){return call_proc0(VV[36],0,(void **)(void *)&LnkLI36);} /* STANDARD-FRPOLY-TEST2 */
static object  LnkTLI35(){return call_proc0(VV[35],0,(void **)(void *)&LnkLI35);} /* STANDARD-FRPOLY-TEST1 */
static object  LnkTLI34(){return call_proc0(VV[34],0,(void **)(void *)&LnkLI34);} /* TESTFRPOLY-4 */
static object  LnkTLI33(){return call_proc0(VV[33],0,(void **)(void *)&LnkLI33);} /* TESTFRPOLY-3 */
static object  LnkTLI32(){return call_proc0(VV[32],0,(void **)(void *)&LnkLI32);} /* TESTFRPOLY-2 */
static object  LnkTLI31(){return call_proc0(VV[31],0,(void **)(void *)&LnkLI31);} /* TESTFRPOLY-1 */
static object  LnkTLI30(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[30],0,(void **)(void *)&LnkLI30,2,first,ap);va_end(ap);return V1;} /* PEXPTSQ */
static void LnkT29(){ call_or_link(VV[29],0,(void **)(void *)&Lnk29);} /* PDIFFER1 */
static object  LnkTLI28(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[28],0,(void **)(void *)&LnkLI28,1,first,ap);va_end(ap);return V1;} /* PTIMES3 */
static object  LnkTLI27(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[27],0,(void **)(void *)&LnkLI27,1,first,ap);va_end(ap);return V1;} /* PTIMES2 */
static object  LnkTLI26(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[26],0,(void **)(void *)&LnkLI26,2,first,ap);va_end(ap);return V1;} /* PTIMES1 */
static object  LnkTLI25(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[25],0,(void **)(void *)&LnkLI25,2,first,ap);va_end(ap);return V1;} /* PCTIMES */
static object  LnkTLI24(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[24],0,(void **)(void *)&LnkLI24,2,first,ap);va_end(ap);return V1;} /* PPLUS1 */
static object  LnkTLI23(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[23],0,(void **)(void *)&LnkLI23,2,first,ap);va_end(ap);return V1;} /* PCPLUS */
static object  LnkTLI22(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[22],0,(void **)(void *)&LnkLI22,2,first,ap);va_end(ap);return V1;} /* PTIMES */
static object  LnkTLI21(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[21],0,(void **)(void *)&LnkLI21,2,first,ap);va_end(ap);return V1;} /* PCTIMES1 */
static object  LnkTLI20(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[20],0,(void **)(void *)&LnkLI20,2,first,ap);va_end(ap);return V1;} /* PPLUS */
static object  LnkTLI19(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[19],0,(void **)(void *)&LnkLI19,3,first,ap);va_end(ap);return V1;} /* PCOEFADD */
static object  LnkTLI18(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[18],0,(void **)(void *)&LnkLI18,2,first,ap);va_end(ap);return V1;} /* PCPLUS1 */
static object  LnkTLI17(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[17],0,(void **)(void *)&LnkLI17,2,first,ap);va_end(ap);return V1;} /* PSIMP */
