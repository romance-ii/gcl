...
/*	local entry for function DDERIV-AUX	*/
...
TTL:;
	V3= (*(LnkLI4))((V2));
	{object V4 = list(3,VV[0],/* INLINE-ARGS */V3,(V2));
	VMR1(V4)}
	return Cnil;
}
/*	local entry for function +DDERIV	*/
...
TTL:;
	...
	goto T5;
T5:;
	(V14->c.c_car)= (*(LnkLI4))((V15->c.c_car));
...
TTL:;
	...
	goto T8;
T8:;
	(V21->c.c_car)= (*(LnkLI12))((V22->c.c_car));
	if((V22=MMcdr(V22))==Cnil){
	V20= base[0];
	goto T7;}
	...
	goto T7;
T7:;
	{object V23 = list(3,VV[3],/* INLINE-ARGS */V19,make_cons(VV[1],V20));
	VMR4(V23)}
	base[0]=base[0];
	return Cnil;
}
...
{	 VMB5 VMS5 VMV5
	goto TTL;
TTL:;
	V26= (*(LnkLI4))(CMPcar((V25)));
	V27= list(3,VV[0],/* INLINE-ARGS */V26,CMPcadr((V25)));
	V28= CMPcar((V25));
	V29= CMPcadr((V25));
	V30= CMPcadr((V25));
	{object V31 = list(3,VV[2],/* INLINE-ARGS */V27,list(3,VV[0],/* INLINE-ARGS */V28,list(4,VV[3],/* INLINE-ARGS */V29,/* INLINE-ARGS */V30,(*(LnkLI4))(CMPcadr((V25))))));
	VMR5(V31)}
	return Cnil;
}
...
TTL:;
	...
	if(!(((V36))==(VV[5]))){
	goto T16;}
	{object V37 = small_fixnum(1);
	VMR7(V37)}
	goto T16;
T16:;
	{object V38 = small_fixnum(0);
	VMR7(V38)}
	goto T13;
T13:;
	{object V39;
	{object V40 =(CMPcar((V36)))->s.s_plist;
	 object ind= VV[4];
	while(V40!=Cnil){
	if(V40->c.c_car==ind){
	V39= (V40->c.c_cdr->c.c_car);
	goto T18;
...
/*	local entry for function DDERIV-RUN	*/
...
T26:;
	...
	(void)((*(LnkLI4))(VV[10]));
	(void)((*(LnkLI4))(VV[11]));
	V43= (fixnum)(V43)+((fixnum)1);
	goto T25;}
	return Cnil;
}
/*	local entry for function TESTDDERIV	*/
...
static object  LnkTLI13(){return call_proc0(VV[13],0,(void **)(void *)&LnkLI13);} /* DDERIV-RUN */
static object  LnkTLI12(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[12],0,(void **)(void *)&LnkLI12,1,first,ap);va_end(ap);return V1;} /* DDERIV-AUX */
static object  LnkTLI4(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[4],0,(void **)(void *)&LnkLI4,1,first,ap);va_end(ap);return V1;} /* DDERIV */
