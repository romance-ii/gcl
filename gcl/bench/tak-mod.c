...
T2:;
	{long V8;
	V8= (fixnum)(*(LnkLI2))((fixnum)(V4)-((fixnum)1),V5,V6);
	{long V9;
	V9= (fixnum)(*(LnkLI2))((fixnum)(V5)-((fixnum)1),V6,V4);
	V6= (fixnum)(*(LnkLI2))((fixnum)(V6)-((fixnum)1),V4,V5);
	V5= V9;
	V4= V8;}}
	goto TTL;
}
/*	local entry for function TESTTAK	*/
...
TTL:;
	...
	if(vs_base>=vs_top){vs_top=sup;goto T13;}
	V15= vs_base[0];
	vs_base++;
...
T15:;
	...
	(void) (*Lnk3)();
	vs_top=sup;
	(void)((*(LnkLI2))((fixnum)18,(fixnum)12,(fixnum)6));
	(void)((*(LnkLI2))((fixnum)18,(fixnum)12,(fixnum)6));
	(void)((*(LnkLI2))((fixnum)18,(fixnum)12,(fixnum)6));
	(void)((*(LnkLI2))((fixnum)18,(fixnum)12,(fixnum)6));
	(void)((*(LnkLI2))((fixnum)18,(fixnum)12,(fixnum)6));
	...
	(void)((*(LnkLI2))((fixnum)18,(fixnum)12,(fixnum)6));
	(void)((*(LnkLI2))((fixnum)18,(fixnum)12,(fixnum)6));
	base[1]= CMPmake_fixnum((long)(*(LnkLI2))((fixnum)18,(fixnum)12,(fixnum)6));
	vs_top=(vs_base=base+1)+1;
	Llist();
	vs_top=sup;
	V14= vs_base[0];
	...
	vs_base=vs_top;
	Lget_internal_run_time();
	if(vs_base>=vs_top){vs_top=sup;goto T35;}
	V17= vs_base[0];
	vs_base++;
	if(vs_base>=vs_top){vs_top=sup;goto T36;}
	V18= vs_base[0];
	vs_top=sup;goto T37;
	goto T35;
T35:;
...
T37:;
	...
	base[1]= (VV[0]->s.s_dbind);
	base[2]= VV[1];
	base[4]= number_minus((V11),(V10));
	base[5]= small_fixnum(100);
	vs_top=(vs_base=base+4)+2;
	Ldivide();
	vs_top=sup;
	base[3]= vs_base[0];
	V19= number_minus((V17),(V15));
	base[5]= number_minus(/* INLINE-ARGS */V19,(V13));
	base[6]= small_fixnum(100);
	vs_top=(vs_base=base+5)+2;
	Ldivide();
	vs_top=sup;
	base[4]= vs_base[0];
	base[6]= number_minus((V18),(V16));
...
static void LnkT4(){ call_or_link(VV[4],0,(void **)(void *)&Lnk4);} /* GET-INTERNAL-REAL-TIME */
static void LnkT3(){ call_or_link(VV[3],0,(void **)(void *)&Lnk3);} /* GBC-TIME */
static object  LnkTLI2(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[2],0,(void **)(void *)&LnkLI2,86275,first,ap);va_end(ap);return V1;} /* TAK */
