...
/*	local entry for function INIT-AUX	*/

static object LI1(V4,V5,V6)

register long V4;register long V5;register object V6;
{	 VMB1 VMS1 VMV1
	goto TTL;
TTL:;
	if(!((V4)==((fixnum)0))){
...
T10:;
	...
	V6= CMPcdr((V6));
	V12= (V13);}
	V10= make_cons((V12),(V10));}
	{register object V14;
	V14= (*(LnkLI6))((fixnum)(V4)-((fixnum)1),V5,(V6));
	V10= make_cons((V14),(V10));}
	V9= (fixnum)(V9)-((fixnum)2);
	goto T9;}
	base[0]=base[0];
	return Cnil;
}
/*	local entry for function FPRINT-INIT	*/

static object LI2(V18,V19,V20)

object V18;object V19;object V20;
{	 VMB2 VMS2 VMV2
	goto TTL;
TTL:;
	{register object V21;
...
T33:;
	...
	goto T30;
T30:;
	{object V23 = (*(LnkLI6))(fix((V18)),fix((V19)),(V21));
	VMR2(V23)}}
	base[0]=base[0];
	return Cnil;
}
/*	local entry for function FPRINT	*/
...
/*	local entry for function TESTFPRINT	*/
...
static object  LnkTLI8(){return call_proc0(VV[8],0,(void **)(void *)&LnkLI8);} /* FPRINT */
static void LnkT7(){ call_or_link(VV[7],0,(void **)(void *)&Lnk7);} /* OPEN */
static object  LnkTLI6(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[6],0,(void **)(void *)&LnkLI6,20483,first,ap);va_end(ap);return V1;} /* INIT-AUX */
