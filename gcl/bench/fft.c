...
TTL:;
	...
	V9= (fixnum)0;
	V10= (fixnum)0;
	V11= (fixnum)((fixnum)((V5))->v.v_dim)-((fixnum)1);
	V12= (fixnum)({fixnum _t=(V11)/((fixnum)2);_t=((V11)<=0 && ((fixnum)2)<=0) || ((V11)>=0 && ((fixnum)2)>=0) || (((fixnum)2)*_t==(V11)) ? _t : _t-1;
	(void)(((V11)-_t*((fixnum)2))); _t;});
	V13= (fixnum)0;
	V14= (fixnum)0;
	V15= (fixnum)0;
	V16=     0.    ;
...
T20:;
	...
	V23= V8;
	V24 = V23;
	V20= ((double *)((V5))->v.v_self)[V24];}
	{long V25;
	V25= V8;
	V26 = V25;
	V21= ((double *)((V6))->v.v_self)[V26];}
	{long V27;
	V27= V8;
	V28 = V27;
	{long V30;
	V30= V7;
	V31 = V30;
	V29= ((double *)((V5))->v.v_self)[V31];}
	(void)(((double *)((V5))->v.v_self)[V28]=V29);}
	{long V32;
	V32= V8;
	V33 = V32;
	{long V35;
	V35= V7;
	V36 = V35;
	V34= ((double *)((V6))->v.v_self)[V36];}
	(void)(((double *)((V6))->v.v_self)[V33]=V34);}
	{long V37;
	V37= V7;
	V38 = V37;
	(void)(((double *)((V5))->v.v_self)[V38]=V20);}
	{long V39;
	V39= V7;
	V40 = V39;
	(void)(((double *)((V6))->v.v_self)[V40]=V21);}
	goto T37;
T37:;
	V9= V12;
	goto T21;
T21:;
	...
	goto T58;}
	V8= (fixnum)(V8)-(V9);
	V9= (fixnum)(V9)/((fixnum)2);
	goto T21;
	goto T58;
T58:;
	V8= (fixnum)(V8)+(V9);
	V7= (fixnum)(V7)+((fixnum)1);
	if(!((V7)<(V11))){
	goto T69;}
	goto T20;
	goto T69;
...
T76:;
	V13= (fixnum)(1<<(V41));
	V14= (fixnum)({fixnum _t=(V13)/((fixnum)2);_t=((V13)<=0 && ((fixnum)2)<=0) || ((V13)>=0 && ((fixnum)2)>=0) || (((fixnum)2)*_t==(V13)) ? _t : _t-1;
	(void)(((V13)-_t*((fixnum)2))); _t;});
	V16=     1.    ;
	V17=     0.    ;
	base[1]= (VV[2]->s.s_dbind);
	base[3]= CMPmake_fixnum(V14);
...
T112:;
	...
	V45= V15;
	V46 = V45;
	V44= ((double *)((V5))->v.v_self)[V46];}
	{double V47= (double)(V44)*(double)(V16);
	{register long V49;
	V49= V15;
	V50 = V49;
	V48= ((double *)((V6))->v.v_self)[V50];}
	V20= (double)(/* INLINE-ARGS */V47)-(double)((double)(V48)*(double)(V17));}
	{register long V52;
	V52= V15;
	V53 = V52;
	V51= ((double *)((V5))->v.v_self)[V53];}
	{double V54= (double)(V51)*(double)(V17);
	{register long V56;
	V56= V15;
	V57 = V56;
	V55= ((double *)((V6))->v.v_self)[V57];}
	V21= (double)(/* INLINE-ARGS */V54)+(double)((double)(V55)*(double)(V16));}
	{register long V58;
	V58= V15;
	V59 = V58;
	{register long V61;
	V61= V43;
	V62 = V61;
	V60= ((double *)((V5))->v.v_self)[V62];}
	(void)(((double *)((V5))->v.v_self)[V59]=(double)(V60)-(double)(V20));}
	{register long V63;
	V63= V15;
	V64 = V63;
	{register long V66;
	V66= V43;
	V67 = V66;
	V65= ((double *)((V6))->v.v_self)[V67];}
	(void)(((double *)((V6))->v.v_self)[V64]=(double)(V65)-(double)(V21));}
	{register long V68;
	V68= V43;
	V69 = V68;
	{register long V71;
	V71= V43;
	V72 = V71;
	V70= ((double *)((V5))->v.v_self)[V72];}
	(void)(((double *)((V5))->v.v_self)[V69]=(double)(V70)+(double)(V20));}
	{register long V73;
	V73= V43;
	V74 = V73;
	{register long V76;
	V76= V43;
	V77 = V76;
	V75= ((double *)((V6))->v.v_self)[V77];}
	(void)(((double *)((V6))->v.v_self)[V74]=(double)(V75)+(double)(V21));}
	V43= (fixnum)(V43)+(V13);
	goto T111;}
	goto T108;
T108:;
	V42= (fixnum)(V42)+((fixnum)1);
	goto T103;}
	goto T100;
T100:;
	V20= (double)((double)(V16)*(double)(V18))-(double)((double)(V17)*(double)(V19));
	V21= (double)((double)(V16)*(double)(V19))+(double)((double)(V17)*(double)(V18));
	V16= V20;
	V17= V21;
	V41= (fixnum)(V41)+((fixnum)1);
	goto T75;}
	goto T72;
T72:;
	{object V78 = Ct;
...
T166:;
	...
	goto T167;
T167:;
	(void)((*(LnkLI12))((VV[3]->s.s_dbind),(VV[4]->s.s_dbind)));
	V80= (fixnum)(V80)+((fixnum)1);
	goto T166;}
	return Cnil;
}
...
T179:;
	...
	V84= V83;
	V85 = V84;
	(void)(((double *)((VV[3]->s.s_dbind))->v.v_self)[V85]=    0.    );}
	{register long V86;
	V86= V83;
	V87 = V86;
	(void)(((double *)((VV[4]->s.s_dbind))->v.v_self)[V87]=    0.    );}
	V83= (fixnum)(V83)+((fixnum)1);
	goto T178;}
	goto T175;
T175:;
...
T191:;
	...
	object V92;
	object V93;
	V94= number_times(small_fixnum(2),VV[6]);
	V91= number_times(/* INLINE-ARGS */V94,(V89));
	V95 = make_longfloat((double)(   0.5    )*(double)(3.1415926535897931    ));
	base[2]= number_times(V95,(V90));
	vs_top=(vs_base=base+2)+1;
	Lcos();
	vs_top=sup;
	V92= vs_base[0];
	V96 = make_longfloat((double)(   0.5    )*(double)(3.1415926535897931    ));
	base[2]= number_times(V96,(V90));
	vs_top=(vs_base=base+2)+1;
	Lsin();
	vs_top=sup;
	V93= vs_base[0];
...
T202:;
	{register object V98;
	base[3]= CMPmake_fixnum(V97);
	base[4]= VV[8];
	vs_top=(vs_base=base+3)+2;
	Ldivide();
	vs_top=sup;
	V99= vs_base[0];
	base[2]= number_times((V91),V99);
	vs_top=(vs_base=base+2)+1;
	Lsin();
	vs_top=sup;
	V98= vs_base[0];
	...
	V105= V101;
	V106 = V105;
	V104= make_longfloat(((double *)((V100))->v.v_self)[V106]);}
	V102= number_plus(V104,(V103));}
	{long V107;
	V107= V101;
	V108 = V107;
	(void)(((double *)((V100))->v.v_self)[V108]=lf((V102)));}}
	{object V109;
	register long V110;
	object V111;
	V109= (VV[4]->s.s_dbind);
	...
	V114= V110;
	V115 = V114;
	V113= make_longfloat(((double *)((V109))->v.v_self)[V115]);}
	V111= number_plus(V113,(V112));}
	{long V116;
	V116= V110;
	V117 = V116;
	(void)(((double *)((V109))->v.v_self)[V117]=lf((V111)));}}}
	V97= (fixnum)(V97)+((fixnum)1);
	goto T201;}}
	goto T193;
T193:;
...
T237:;
	...
	goto T238;
T238:;
	{register double V119;
	register double V120;
	{register long V121;
	V121= V118;
	V122 = V121;
	V119= ((double *)((VV[3]->s.s_dbind))->v.v_self)[V122];}
	{register long V123;
	V123= V118;
	V124 = V123;
	V120= ((double *)((VV[4]->s.s_dbind))->v.v_self)[V124];}
	V125 = make_longfloat(V119);
	V126= (*(LnkLI14))(V125);
	if(!(number_compare(/* INLINE-ARGS */V126,(VV[9]->s.s_dbind))<0)){
	goto T247;}
	V127 = make_longfloat(V120);
	V128= (*(LnkLI14))(V127);
	if(number_compare(/* INLINE-ARGS */V128,(VV[9]->s.s_dbind))<0){
	goto T242;}
	goto T247;
T247:;
	base[0]= Ct;
	base[1]= VV[10];
	base[2]= CMPmake_fixnum(V118);
	base[3]= make_longfloat(V119);
	base[4]= make_longfloat(V120);
	vs_top=(vs_base=base+0)+5;
	Lformat();
	vs_top=sup;}
	goto T242;
T242:;
	V118= (fixnum)(V118)+((fixnum)1);
	goto T237;}
	goto T234;
T234:;
	vs_base=vs_top=base+0;
...
static object  LnkTLI14(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[14],0,(void **)(void *)&LnkLI14,1,first,ap);va_end(ap);return V1;} /* ABS */
static object  LnkTLI13(){return call_proc0(VV[13],0,(void **)(void *)&LnkLI13);} /* FFT-BENCH */
static object  LnkTLI12(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[12],0,(void **)(void *)&LnkLI12,2,first,ap);va_end(ap);return V1;} /* FFT */
