...
#include "destru-mod.h"
void init_code(){do_init(VV);}
/*	local entry for function DESTRUCTIVE	*/
...
T4:;
	...
	goto T5;
T5:;
	V6= (fixnum)(V6)-((fixnum)1);
	V7= make_cons(Cnil,(V7));
	goto T4;}
	goto T1;
T1:;
	{register long V9;
...
T27:;{object V12;
	V12= CMPcar((V11));
	if(V12==Cnil)goto T32;
	goto T31;
	goto T32;
T32:;}
	V13= make_cons(Cnil,Cnil);
	((V11))->c.c_car = /* INLINE-ARGS */V13;
	goto T31;
T31:;
	V14= CMPcar((V11));
	{register long V16;
...
T38:;
	...
	goto T39;
T39:;
	V16= (fixnum)(V16)-((fixnum)1);
	V17= make_cons(Cnil,(V17));
	goto T38;}
	goto T35;
T35:;
	(void)(nconc(/* INLINE-ARGS */V14,V15));
	V11= CMPcdr((V11));
	goto T26;}
	goto T23;
T23:;
...
T54:;
	{register long V22;
	register object V23;
	{long V24= (fixnum)length(CMPcar((V20)));
	V22= (fixnum)({fixnum _t=(/* INLINE-ARGS */V24)/((fixnum)2);_t=((/* INLINE-ARGS */V24)<=0 && ((fixnum)2)<=0) || ((/* INLINE-ARGS */V24)>=0 && ((fixnum)2)>=0) || (((fixnum)2)*_t==(/* INLINE-ARGS */V24)) ? _t : _t-1;
	(void)(((/* INLINE-ARGS */V24)-_t*((fixnum)2))); _t;});}
	V23= CMPcar((V20));
	goto T63;
T63:;
	if(!((V22)==0)){
...
T59:;
	{long V27;
	{long V28= (fixnum)length(CMPcar((V19)));
	V27= (fixnum)({fixnum _t=(/* INLINE-ARGS */V28)/((fixnum)2);_t=((/* INLINE-ARGS */V28)<=0 && ((fixnum)2)<=0) || ((/* INLINE-ARGS */V28)>=0 && ((fixnum)2)>=0) || (((fixnum)2)*_t==(/* INLINE-ARGS */V28)) ? _t : _t-1;
	(void)(((/* INLINE-ARGS */V28)-_t*((fixnum)2))); _t;});}
	if(!((V27)==((fixnum)0))){
	goto T76;}
	((V19))->c.c_car = Cnil;
	V26= CMPcar((V19));
...
T82:;
	...
	goto T83;
T83:;
	V32 = CMPmake_fixnum(V9);
	((V30))->c.c_car = V32;
	V29= (fixnum)(V29)-((fixnum)1);
	V30= CMPcdr((V30));
	goto T82;}}
	goto T73;
T73:;
...
/*	local entry for function TESTDESTRU	*/
...
{	 VMB2 VMS2 VMV2
	goto TTL;
TTL:;
	{object V33 = (*(LnkLI0))((fixnum)600,(fixnum)50);
	VMR2(V33)}
	return Cnil;
}
static object  LnkTLI0(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[0],0,(void **)(void *)&LnkLI0,20482,first,ap);va_end(ap);return V1;} /* DESTRUCTIVE */
