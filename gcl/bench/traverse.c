...
/*	function definition for MAKE-NODE	*/
...
{register object *base=vs_base;
	...
	object V9;
	object V10;
	parse_key(vs_base,FALSE,FALSE,10,VV[6],VV[7],VV[8],VV[9],VV[10],VV[11],VV[12],VV[13],VV[14],VV[15]);vs_top=sup;
	V1=(base[0]);
	V2=(base[1]);
	if(base[12]==Cnil){
	V3= (*(LnkLI16))();
	...
	base[29]= (V9);
	base[30]= (V10);
	vs_top=(vs_base=base+20)+11;
	siLmake_structure();
	return;
	}
}
/*	local entry for function SNB	*/
...
{	 VMB2 VMS2 VMV2
	goto TTL;
TTL:;
	(VV[1]->s.s_dbind)= CMPmake_fixnum((long)(fix((VV[1]->s.s_dbind)))+((fixnum)1));
	{object V11 = (VV[1]->s.s_dbind);
	VMR2(V11)}
	return Cnil;
}
/*	local entry for function TRAVERSE-SEED	*/
...
{	 VMB3 VMS3 VMV3
	goto TTL;
TTL:;
	(VV[2]->s.s_dbind)= small_fixnum(21);
	{object V12 = small_fixnum(21);
	VMR3(V12)}
	return Cnil;
}
/*	local entry for function TRAVERSE-RANDOM	*/
...
{	 VMB4 VMS4 VMV4
	goto TTL;
TTL:;
	(VV[2]->s.s_dbind)= CMPmake_fixnum((long)((fixnum)(fix((VV[2]->s.s_dbind)))*((fixnum)17))%((fixnum)251));
	{object V13 = (VV[2]->s.s_dbind);
	VMR4(V13)}
	return Cnil;
}
/*	local entry for function TRAVERSE-REMOVE	*/

static object LI5(V16,V17)

long V16;register object V17;
{	 VMB5 VMS5 VMV5
	goto TTL;
TTL:;
	if(!((CMPcdr(CMPcar((V17))))==(CMPcar((V17))))){
	goto T17;}
	{object V18;
	V18= CMPcaar((V17));
	((V17))->c.c_car = Cnil;
...
T17:;
	...
	goto T30;
T30:;
	if(!((CMPcdr((V21)))==(CMPcar((V17))))){
	goto T31;}
	((V21))->c.c_cdr = CMPcdr(CMPcar((V17)));
	V22= (V21);
	((V17))->c.c_car = V22;
	goto T27;
	goto T31;
...
/*	local entry for function TRAVERSE-SELECT	*/

static object LI6(V31,V32)
...
T59:;
	if(!((V33)==((fixnum)0))){
	goto T60;}
	{object V35 = CMPcar((V34));
	VMR6(V35)}
	goto T60;
T60:;
	V33= (fixnum)(V33)-((fixnum)1);
	V34= CMPcdr((V34));
	goto T59;}
	return Cnil;
}
/*	local entry for function TRAVERSE-ADD	*/

static object LI7(V38,V39)

register object V38;register object V39;
{	 VMB7 VMS7 VMV7
	goto TTL;
TTL:;
	if(((V39))!=Cnil){
	goto T69;}
	{object V41;
	V41= make_cons((V38),Cnil);
	((V41))->c.c_cdr = (V41);
	V40= (V41);}
	{object V42 = make_cons(V40,Cnil);
	VMR7(V42)}
	goto T69;
T69:;
	if((CMPcar((V39)))!=Cnil){
...
T75:;
	V46= CMPcar((V39));
	V47= make_cons((V38),CMPcdr(CMPcar((V39))));
	(/* INLINE-ARGS */V46)->c.c_cdr = /* INLINE-ARGS */V47;
	V45= /* INLINE-ARGS */V46;
	((V39))->c.c_car = V45;
	{object V48 = (V39);
	VMR7(V48)}
...
/*	local entry for function TRAVERSE-CREATE-STRUCTURE	*/

static object LI8(V50)
...
TTL:;
	...
	vs_top=sup;
	V52= vs_base[0];
	V51= make_cons(V52,Cnil);
	{register long V53;
	object V54;
	V53= (fixnum)(V50)-((fixnum)1);
	V54= (V51);
	goto T84;
T84:;
	if(!((V53)==((fixnum)0))){
	...
	((V54))->c.c_cdr = (V51);
	V55= (V54);
	V51= make_cons(V55,Cnil);
	{register object V56;
	register object V57;
	register object V58;
	register object V59;
	V60= (*(LnkLI19))((fixnum)0,(V51));
	V57= (*(LnkLI18))(/* INLINE-ARGS */V60,Cnil);
	V56= (V51);
	V58= Cnil;
	V59= Cnil;
	goto T93;
T93:;
	if((CMPcar((V56)))!=Cnil){
	goto T94;}
	V61= (*(LnkLI21))((fixnum)0,(V57));
	{object V62 = (*(LnkLI20))(/* INLINE-ARGS */V61,V50);
	VMR8(V62)}
	goto T94;
T94:;
	{long V63= fix((*(LnkLI22))());
	V58= (*(LnkLI19))((fixnum)(/* INLINE-ARGS */V63)%(V50),(V56));}
	{long V64= fix((*(LnkLI22))());
	V59= (*(LnkLI21))((fixnum)(/* INLINE-ARGS */V64)%(V50),(V57));}
	(void)((*(LnkLI18))((V58),(V57)));
	V65= make_cons((V58),STREF(object,(V59),4));
	V66= Ct;
	STSET(object,(V59),4, /* INLINE-ARGS */V65);
	(void)(/* INLINE-ARGS */V65);
	V67= make_cons((V59),STREF(object,(V58),0));
	V68= Ct;
	STSET(object,(V58),0, /* INLINE-ARGS */V67);
...
T85:;
	...
	vs_top=sup;
	V69= vs_base[0];
	V51= make_cons((V69),(V51));}
	V53= (fixnum)(V53)-((fixnum)1);
	goto T84;}}
	base[0]=base[0];
	return Cnil;
}
/*	local entry for function FIND-ROOT	*/

static object LI9(V72,V73)

register object V72;long V73;
{	 VMB9 VMS9 VMV9
	goto TTL;
TTL:;
	{register long V74;
...
T116:;
	...
	goto T117;
T117:;
	if((STREF(object,(V72),0))!=Cnil){
	goto T123;}
	{object V76 = (V72);
	VMR9(V76)}
	goto T123;
T123:;
	V72= CMPcar(STREF(object,(V72),0));
	V74= (fixnum)(V74)-((fixnum)1);
	goto T116;}
	return Cnil;
}
/*	local entry for function TRAVERS	*/

static object LI10(V79,V80)

register object V79;register object V80;
{	 VMB10 VMS10 VMV10
	goto TTL;
TTL:;
	if(!((STREF(object,(V79),36))==((V80)))){
	goto T130;}
	{object V81 = Cnil;
	VMR10(V81)}
	goto T130;
T130:;
	V82= Ct;
	STSET(object,(V79),36, (V80));
	(void)((V80));
	(VV[3]->s.s_dbind)= CMPmake_fixnum((long)(fix((VV[3]->s.s_dbind)))+((fixnum)1));
	V83= ((STREF(object,(V79),12))==Cnil?Ct:Cnil);
	V84= Ct;
	STSET(object,(V79),12, /* INLINE-ARGS */V83);
	(void)(/* INLINE-ARGS */V83);
	V85= ((STREF(object,(V79),16))==Cnil?Ct:Cnil);
	V86= Ct;
	STSET(object,(V79),16, /* INLINE-ARGS */V85);
	(void)(/* INLINE-ARGS */V85);
	V87= ((STREF(object,(V79),20))==Cnil?Ct:Cnil);
	V88= Ct;
	STSET(object,(V79),20, /* INLINE-ARGS */V87);
	(void)(/* INLINE-ARGS */V87);
	V89= ((STREF(object,(V79),24))==Cnil?Ct:Cnil);
	V90= Ct;
	STSET(object,(V79),24, /* INLINE-ARGS */V89);
	(void)(/* INLINE-ARGS */V89);
	V91= ((STREF(object,(V79),28))==Cnil?Ct:Cnil);
	V92= Ct;
	STSET(object,(V79),28, /* INLINE-ARGS */V91);
	(void)(/* INLINE-ARGS */V91);
	V93= ((STREF(object,(V79),32))==Cnil?Ct:Cnil);
	V94= Ct;
	STSET(object,(V79),32, /* INLINE-ARGS */V93);
	(void)(/* INLINE-ARGS */V93);
	{register object V95;
	V95= STREF(object,(V79),4);
	goto T143;
T143:;
	if(((V95))!=Cnil){
	goto T144;}
	...
	goto T144;
T144:;
	(void)((*(LnkLI23))(CMPcar((V95)),(V80)));
	V95= CMPcdr((V95));
	goto T143;}
	return Cnil;
}
/*	local entry for function TRAVERSE	*/

static object LI11(V98)
...
TTL:;
	bds_bind(VV[4],V98);
	bds_bind(VV[3],small_fixnum(0));{object V99;
	V99= (VV[4]->s.s_dbind);
	(VV[5]->s.s_dbind)= (((VV[5]->s.s_dbind))==Cnil?Ct:Cnil);
	(void)((*(LnkLI23))(V99,(VV[5]->s.s_dbind)));}
	{object V100 = (VV[3]->s.s_dbind);
	bds_unwind1;
	bds_unwind1;
	VMR11(V100)}
	base[0]=base[0];
...
/*	local entry for function INIT-TRAVERSE	*/
...
{	 VMB12 VMS12 VMV12
	goto TTL;
TTL:;
	(VV[4]->s.s_dbind)= (*(LnkLI24))((fixnum)100);
	{object V101 = Cnil;
	VMR12(V101)}
	return Cnil;
}
/*	local entry for function RUN-TRAVERSE	*/
...
T158:;
	...
	goto T159;
T159:;
	(void)((*(LnkLI25))((VV[4]->s.s_dbind)));
	(void)((*(LnkLI25))((VV[4]->s.s_dbind)));
	(void)((*(LnkLI25))((VV[4]->s.s_dbind)));
	(void)((*(LnkLI25))((VV[4]->s.s_dbind)));
	(void)((*(LnkLI25))((VV[4]->s.s_dbind)));
	V102= (fixnum)(V102)-((fixnum)1);
	goto T158;}
	return Cnil;
}
/*	local entry for function TESTTRAVERSE	*/
...
/*	local entry for function TESTTRAVERSE-INIT	*/
...
/*	local entry for function TESTTRAVERSE-RUN	*/
...
static object  LnkTLI29(){return call_proc0(VV[29],0,(void **)(void *)&LnkLI29);} /* RUN-TRAVERSE */
static object  LnkTLI28(){return call_proc0(VV[28],0,(void **)(void *)&LnkLI28);} /* INIT-TRAVERSE */
static object  LnkTLI27(){return call_proc0(VV[27],0,(void **)(void *)&LnkLI27);} /* TESTTRAVERSE-RUN */
static object  LnkTLI26(){return call_proc0(VV[26],0,(void **)(void *)&LnkLI26);} /* TESTTRAVERSE-INIT */
static object  LnkTLI25(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[25],0,(void **)(void *)&LnkLI25,1,first,ap);va_end(ap);return V1;} /* TRAVERSE */
static object  LnkTLI24(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[24],0,(void **)(void *)&LnkLI24,4097,first,ap);va_end(ap);return V1;} /* TRAVERSE-CREATE-STRUCTURE */
static object  LnkTLI23(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[23],0,(void **)(void *)&LnkLI23,2,first,ap);va_end(ap);return V1;} /* TRAVERS */
static object  LnkTLI22(){return call_proc0(VV[22],0,(void **)(void *)&LnkLI22);} /* TRAVERSE-RANDOM */
static object  LnkTLI21(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[21],0,(void **)(void *)&LnkLI21,4098,first,ap);va_end(ap);return V1;} /* TRAVERSE-SELECT */
static object  LnkTLI20(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[20],0,(void **)(void *)&LnkLI20,16386,first,ap);va_end(ap);return V1;} /* FIND-ROOT */
static object  LnkTLI19(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[19],0,(void **)(void *)&LnkLI19,4098,first,ap);va_end(ap);return V1;} /* TRAVERSE-REMOVE */
static object  LnkTLI18(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[18],0,(void **)(void *)&LnkLI18,2,first,ap);va_end(ap);return V1;} /* TRAVERSE-ADD */
static void LnkT17(){ call_or_link(VV[17],0,(void **)(void *)&Lnk17);} /* MAKE-NODE */
static object  LnkTLI16(){return call_proc0(VV[16],0,(void **)(void *)&LnkLI16);} /* SNB */
