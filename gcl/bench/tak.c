...
T2:;
	{long V8;
	V8= fix((*(LnkLI2))((fixnum)(V4)-((fixnum)1),V5,V6));
	{long V9;
	V9= fix((*(LnkLI2))((fixnum)(V5)-((fixnum)1),V6,V4));
	V6= fix((*(LnkLI2))((fixnum)(V6)-((fixnum)1),V4,V5));
	V5= V9;
	V4= V8;}}
	goto TTL;
	return Cnil;
...
T15:;
	...
	(void)((*(LnkLI2))((fixnum)18,(fixnum)12,(fixnum)6));
	(void)((*(LnkLI2))((fixnum)18,(fixnum)12,(fixnum)6));
	base[1]= (*(LnkLI2))((fixnum)18,(fixnum)12,(fixnum)6);
	vs_top=(vs_base=base+1)+1;
	Llist();
	vs_top=sup;
	V14= vs_base[0];
...
static object  LnkTLI2(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[2],0,(void **)(void *)&LnkLI2,86019,first,ap);va_end(ap);return V1;} /* TAK */
