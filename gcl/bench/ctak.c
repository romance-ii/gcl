...
/*	local entry for function CTAK	*/

static object LI1(V4,V5,V6)

VOL object V4;VOL object V5;VOL object V6;
{	 VMB1 VMS1 VMV1
	goto TTL;
TTL:;
	...
	V8= (*(LnkLI1))(fix((V4)),fix((V5)),fix((V6)));
	frs_pop();
	{object V9 = V8;
	VMR1(V9)}}
	base[0]=base[0];
...
/*	local entry for function CTAK-AUX	*/

static object LI2(V13,V14,V15)

VOL long V13;VOL long V14;VOL long V15;
{	 VMB2 VMS2 VMV2
	goto TTL;
TTL:;
	if((V14)<(V13)){
	...
	if(fr==NULL) FEerror("The tag ~s is undefined.",1,VV[0]);
	base[0]= CMPmake_fixnum(V15);
...
T3:;
	...
	V17= (*(LnkLI1))((fixnum)(V13)-((fixnum)1),V14,V15);
	frs_pop();
	V16= fix(V17);}
	goto T7;
T7:;
	...
	V19= (*(LnkLI1))((fixnum)(V14)-((fixnum)1),V15,V13);
	frs_pop();
	V18= fix(V19);}
	goto T9;
T9:;
	...
	V20= (*(LnkLI1))((fixnum)(V15)-((fixnum)1),V13,V14);
	frs_pop();
	V15= fix(V20);}
	goto T11;
T11:;
...
/*	local entry for function TESTCTAK	*/
...
{	 VMB3 VMS3 VMV3
	goto TTL;
TTL:;
	{object V21 = (*(LnkLI0))(small_fixnum(18),small_fixnum(12),small_fixnum(6));
	VMR3(V21)}
	return Cnil;
}
static object  LnkTLI0(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[0],0,(void **)(void *)&LnkLI0,3,first,ap);va_end(ap);return V1;} /* CTAK */
static object  LnkTLI1(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[1],0,(void **)(void *)&LnkLI1,86019,first,ap);va_end(ap);return V1;} /* CTAK-AUX */
