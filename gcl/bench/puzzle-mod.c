...
{register object *base=vs_base;
	...
	V1=V1->c.c_cdr;
	base[3]= (V1->c.c_car);}
	base[4]= list(3,VV[0],VV[1],list(3,VV[2],base[2],list(3,VV[0],VV[1],base[3])));
...
register long V4;register long V5;
{	 VMB2 VMS2 VMV2
	goto TTL;
TTL:;
	{register long V6;
	...
	V7= V4;
	V8 = V7;
	V6= (fixnum)((fixnum *)((VV[3]->s.s_dbind))->v.v_self)[V8];}
	{register long V9;
	V9= (fixnum)0;
	goto T5;
T5:;
...
T6:;
	{register long V11;
	V11= (fixnum)((fixnum)(V4)*((fixnum)((VV[4]->s.s_dbind))->a.a_dims[((fixnum)1)]))+(V9);
	V12 = V11;
	if((((object *)((VV[4]->s.s_dbind))->v.v_self)[V12])==Cnil){
	goto T10;}}
	{register long V13;
	V13= (fixnum)(V5)+(V9);
	V14 = V13;
	if((((object *)((VV[5]->s.s_dbind))->v.v_self)[V14])==Cnil){
	goto T10;}}
	{object V15 = Cnil;
	VMR2(V15)}
	goto T10;
T10:;
	V9= (fixnum)(V9)+((fixnum)1);
	goto T5;}}
	return Cnil;
}
/*	local entry for function JIL	*/
...
{	 VMB3 VMS3 VMV3
	goto TTL;
TTL:;
	{object V16 = small_fixnum(3);
	VMR3(V16)}
	return Cnil;
}
/*	local entry for function PLACE	*/

static object LI4(V19,V20)

register long V19;register long V20;
{	 VMB4 VMS4 VMV4
	goto TTL;
TTL:;
	{register long V21;
	...
	V22= V19;
	V23 = V22;
	V21= (fixnum)((fixnum *)((VV[3]->s.s_dbind))->v.v_self)[V23];}
	{register long V24;
	V24= (fixnum)0;
	goto T25;
T25:;
...
T26:;
	{register long V25;
	V25= (fixnum)((fixnum)(V19)*((fixnum)((VV[4]->s.s_dbind))->a.a_dims[((fixnum)1)]))+(V24);
	V26 = V25;
	if((((object *)((VV[4]->s.s_dbind))->v.v_self)[V26])==Cnil){
	goto T30;}}
	{register long V27;
	V27= (fixnum)(V20)+(V24);
	V28 = V27;
	(void)(((object *)((VV[5]->s.s_dbind))->v.v_self)[V28]=Ct);}
	goto T30;
T30:;
...
T22:;
	...
	V30= V19;
	V31 = V30;
	V29= (fixnum)((fixnum *)((VV[6]->s.s_dbind))->v.v_self)[V31];}{object V32;
	V32= (VV[7]->s.s_dbind);
	V33 = V29;
	{long V35;
	{long V36;
	V36= V19;
	V37 = V36;
	V35= (fixnum)((fixnum *)((VV[6]->s.s_dbind))->v.v_self)[V37];}
	V38 = V35;
	V34= (fixnum)((fixnum *)((VV[7]->s.s_dbind))->v.v_self)[V38];}
	(void)(((fixnum *)(V32)->v.v_self)[V33]=(fixnum)(V34)-((fixnum)1));}}
	{register long V39;
	V39= V20;
	goto T46;
T46:;
...
T47:;
	...
	V41= V39;
	V42 = V41;
	if((((object *)((VV[5]->s.s_dbind))->v.v_self)[V42])!=Cnil){
	goto T53;}}
	{long V43 = V39;
	VMR4((object)V43)}
	goto T53;
T53:;
	V39= (fixnum)(V39)+((fixnum)1);
	goto T46;}}
}
/*	local entry for function PUZZLE-REMOVE	*/

static object LI5(V46,V47)

register long V46;register long V47;
{	 VMB5 VMS5 VMV5
	goto TTL;
TTL:;
	{register long V48;
	...
	V49= V46;
	V50 = V49;
	V48= (fixnum)((fixnum *)((VV[3]->s.s_dbind))->v.v_self)[V50];}
	{register long V51;
	V51= (fixnum)0;
	goto T65;
T65:;
...
T66:;
	{register long V52;
	V52= (fixnum)((fixnum)(V46)*((fixnum)((VV[4]->s.s_dbind))->a.a_dims[((fixnum)1)]))+(V51);
	V53 = V52;
	if((((object *)((VV[4]->s.s_dbind))->v.v_self)[V53])==Cnil){
	goto T70;}}
	{register long V54;
	V54= (fixnum)(V47)+(V51);
	V55 = V54;
	(void)(((object *)((VV[5]->s.s_dbind))->v.v_self)[V55]=Cnil);}
	goto T70;
T70:;
	V51= (fixnum)(V51)+((fixnum)1);
	goto T65;}
	goto T62;
T62:;
	{long V56;
	...
	V57= V46;
	V58 = V57;
	V56= (fixnum)((fixnum *)((VV[6]->s.s_dbind))->v.v_self)[V58];}{object V59;
	V59= (VV[7]->s.s_dbind);
	V60 = V56;
	{long V62;
	{long V63;
	V63= V46;
	V64 = V63;
	V62= (fixnum)((fixnum *)((VV[6]->s.s_dbind))->v.v_self)[V64];}
	V65 = V62;
	V61= (fixnum)((fixnum *)((VV[7]->s.s_dbind))->v.v_self)[V65];}
	{object V66 = CMPmake_fixnum((long)((fixnum *)(V59)->v.v_self)[V60]=(fixnum)(V61)+((fixnum)1));
	VMR5(V66)}}}}
	return Cnil;
}
/*	local entry for function TRIAL	*/

static object LI6(V68)
...
T86:;
	if(!((V70)>((fixnum)12))){
	goto T87;}
	(VV[8]->s.s_dbind)= CMPmake_fixnum((long)(fix((VV[8]->s.s_dbind)))+((fixnum)1));
	{object V71 = Cnil;
	VMR6(V71)}
	goto T87;
T87:;
	...
	V74= V70;
	V75 = V74;
	V73= (fixnum)((fixnum *)((VV[6]->s.s_dbind))->v.v_self)[V75];}
	V76 = V73;
	V72= (fixnum)((fixnum *)((VV[7]->s.s_dbind))->v.v_self)[V76];}
	if((V72)==((fixnum)0)){
	goto T93;}
	if(((*(LnkLI17))(V70,V68))==Cnil){
	goto T93;}
	V69= (fixnum)(*(LnkLI18))(V70,V68);
	if(((*(LnkLI19))(V69))!=Cnil){
	goto T103;}
	if(!((V69)==((fixnum)0))){
	goto T104;}
...
T103:;
	...
	goto T104;
T104:;
	(void)((*(LnkLI20))(V70,V68));
	goto T93;
T93:;
	V70= (fixnum)(V70)+((fixnum)1);
	goto T86;}}
	return Cnil;
}
/*	local entry for function DEFINEPIECE	*/

static object LI7(V82,V83,V84,V85)

object V82;long V83;long V84;register long V85;
{	 VMB7 VMS7 VMV7
	goto TTL;
TTL:;
	{register long V86;
...
T134:;{object V90;
	V90= (VV[9]->s.s_dbind);
	V86= (fixnum)(V87)+((fixnum)(fix(V90))*((fixnum)(V88)+((fixnum)(fix((VV[9]->s.s_dbind)))*(V89))));}
	{register long V91;{object V92;
	V92= (VV[10]->s.s_dbind);
	V91= (fixnum)((fixnum)(fix(V92))*((fixnum)((VV[4]->s.s_dbind))->a.a_dims[((fixnum)1)]))+(V86);}
	V93 = V91;
	(void)(((object *)((VV[4]->s.s_dbind))->v.v_self)[V93]=Ct);}
	V89= (fixnum)(V89)+((fixnum)1);
	goto T133;}
	goto T130;
T130:;
	V88= (fixnum)(V88)+((fixnum)1);
	goto T125;}
	goto T122;
T122:;
	V87= (fixnum)(V87)+((fixnum)1);
	goto T117;}
	goto T114;
T114:;
	{long V94;
	V94= fix((VV[10]->s.s_dbind));
	V95 = V94;
	(void)(((fixnum *)((VV[6]->s.s_dbind))->v.v_self)[V95]=fix((V82)));}
	{long V96;
	V96= fix((VV[10]->s.s_dbind));
	V97 = V96;
	(void)(((fixnum *)((VV[3]->s.s_dbind))->v.v_self)[V97]=V86);}
	if((fix((VV[10]->s.s_dbind)))==((fixnum)12)){
	goto T156;}
	(VV[10]->s.s_dbind)= CMPmake_fixnum((long)(fix((VV[10]->s.s_dbind)))+((fixnum)1));
	{object V98 = (VV[10]->s.s_dbind);
	VMR7(V98)}
	goto T156;
T156:;
	{object V99 = Cnil;
...
/*	local entry for function PUZZLE-START	*/
...
T163:;
	...
	V101= V100;
	V102 = V101;
	(void)(((object *)((VV[5]->s.s_dbind))->v.v_self)[V102]=Ct);}
	V100= (fixnum)(V100)+((fixnum)1);
	goto T162;}
	goto T159;
T159:;
	{register long V103;
...
T191:;
	...
	goto T192;
T192:;
	{register long V106;{object V107;
	V107= (VV[9]->s.s_dbind);
	V106= (fixnum)(V103)+((fixnum)(fix(V107))*((fixnum)(V104)+((fixnum)(fix((VV[9]->s.s_dbind)))*(V105))));}
	V108 = V106;
	(void)(((object *)((VV[5]->s.s_dbind))->v.v_self)[V108]=Cnil);}
	V105= (fixnum)(V105)+((fixnum)1);
	goto T191;}
	goto T188;
T188:;
	V104= (fixnum)(V104)+((fixnum)1);
	goto T183;}
	goto T180;
T180:;
	V103= (fixnum)(V103)+((fixnum)1);
	goto T175;}
	goto T172;
T172:;
	{register long V109;
...
T219:;
	{register long V111;
	V111= (fixnum)((fixnum)(V109)*((fixnum)((VV[4]->s.s_dbind))->a.a_dims[((fixnum)1)]))+(V110);
	V112 = V111;
	(void)(((object *)((VV[4]->s.s_dbind))->v.v_self)[V112]=Cnil);}
	V110= (fixnum)(V110)+((fixnum)1);
	goto T218;}
	goto T215;
T215:;
	V109= (fixnum)(V109)+((fixnum)1);
	goto T210;}
	goto T207;
T207:;
	(VV[10]->s.s_dbind)= small_fixnum(0);
	(void)((*(LnkLI21))(small_fixnum(0),(fixnum)3,(fixnum)1,(fixnum)0));
	(void)((*(LnkLI21))(small_fixnum(0),(fixnum)1,(fixnum)0,(fixnum)3));
	(void)((*(LnkLI21))(small_fixnum(0),(fixnum)0,(fixnum)3,(fixnum)1));
	(void)((*(LnkLI21))(small_fixnum(0),(fixnum)1,(fixnum)3,(fixnum)0));
	(void)((*(LnkLI21))(small_fixnum(0),(fixnum)3,(fixnum)0,(fixnum)1));
	(void)((*(LnkLI21))(small_fixnum(0),(fixnum)0,(fixnum)1,(fixnum)3));
	(void)((*(LnkLI21))(small_fixnum(1),(fixnum)2,(fixnum)0,(fixnum)0));
	(void)((*(LnkLI21))(small_fixnum(1),(fixnum)0,(fixnum)2,(fixnum)0));
	(void)((*(LnkLI21))(small_fixnum(1),(fixnum)0,(fixnum)0,(fixnum)2));
	(void)((*(LnkLI21))(small_fixnum(2),(fixnum)1,(fixnum)1,(fixnum)0));
	(void)((*(LnkLI21))(small_fixnum(2),(fixnum)1,(fixnum)0,(fixnum)1));
	(void)((*(LnkLI21))(small_fixnum(2),(fixnum)0,(fixnum)1,(fixnum)1));
	(void)((*(LnkLI21))(small_fixnum(3),(fixnum)1,(fixnum)1,(fixnum)1));
	{long V113;
	V113= (fixnum)0;
	V114 = V113;
	(void)(((fixnum *)((VV[7]->s.s_dbind))->v.v_self)[V114]=(fixnum)13);}
	{long V115;
	V115= (fixnum)1;
	V116 = V115;
	(void)(((fixnum *)((VV[7]->s.s_dbind))->v.v_self)[V116]=(fixnum)3);}
	{long V117;
	V117= (fixnum)2;
	V118 = V117;
	(void)(((fixnum *)((VV[7]->s.s_dbind))->v.v_self)[V118]=(fixnum)1);}
	{long V119;
	V119= (fixnum)3;
	V120 = V119;
	(void)(((fixnum *)((VV[7]->s.s_dbind))->v.v_self)[V120]=(fixnum)1);}
	{long V121;
	long V122;{object V123;
	V123= (VV[9]->s.s_dbind);
	V121= (fixnum)((fixnum)1)+((fixnum)(fix(V123))*((fixnum)((fixnum)1)+(fix((VV[9]->s.s_dbind)))));}
	V122= (fixnum)0;
	bds_bind(VV[8],small_fixnum(0));
	if(((*(LnkLI17))((fixnum)0,V121))==Cnil){
	goto T258;}
	V122= (fixnum)(*(LnkLI18))((fixnum)0,V121);
	goto T256;
	goto T258;
T258:;
	base[1]= Ct;
...
/*	local entry for function TESTPUZZLE	*/
...
T290:;
	...
	vs_top=sup;
	V127= vs_base[0];
	base[0]= (VV[14]->s.s_dbind);
	vs_top=(vs_base=base+0)+1;
	Lfresh_line();
	vs_top=sup;
	base[0]= (VV[14]->s.s_dbind);
	base[1]= VV[15];
	base[3]= number_minus((V127),(V126));
	base[4]= small_fixnum(100);
	vs_top=(vs_base=base+3)+2;
	Ldivide();
	vs_top=sup;
	base[2]= vs_base[0];
	V135= number_minus((V133),(V131));
	base[4]= number_minus(/* INLINE-ARGS */V135,(V129));
	base[5]= small_fixnum(100);
	vs_top=(vs_base=base+4)+2;
	Ldivide();
	vs_top=sup;
	base[3]= vs_base[0];
	base[5]= number_minus((V134),(V132));
	base[6]= small_fixnum(100);
	vs_top=(vs_base=base+5)+2;
	Ldivide();
	vs_top=sup;
	base[4]= vs_base[0];
	base[6]= (V129);
	base[7]= small_fixnum(100);
...
static object  LnkTLI24(){return call_proc0(VV[24],0,(void **)(void *)&LnkLI24);} /* PUZZLE-START */
static void LnkT23(){ call_or_link(VV[23],0,(void **)(void *)&Lnk23);} /* GET-INTERNAL-REAL-TIME */
static void LnkT22(){ call_or_link(VV[22],0,(void **)(void *)&Lnk22);} /* GBC-TIME */
static object  LnkTLI21(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[21],0,(void **)(void *)&LnkLI21,344068,first,ap);va_end(ap);return V1;} /* DEFINEPIECE */
static object  LnkTLI20(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[20],0,(void **)(void *)&LnkLI20,20482,first,ap);va_end(ap);return V1;} /* PUZZLE-REMOVE */
static object  LnkTLI19(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[19],0,(void **)(void *)&LnkLI19,4097,first,ap);va_end(ap);return V1;} /* TRIAL */
static object  LnkTLI18(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[18],0,(void **)(void *)&LnkLI18,20738,first,ap);va_end(ap);return V1;} /* PLACE */
static object  LnkTLI17(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[17],0,(void **)(void *)&LnkLI17,20482,first,ap);va_end(ap);return V1;} /* FIT */
static object  LnkTLI16(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[16],0,(void **)(void *)&LnkLI16,16642,first,ap);va_end(ap);return V1;} /* CMP-ARRAY-DIMENSION */
