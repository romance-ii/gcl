  ...
  (nconc (mapcar #'(lambda (symbol)
	 ...
	 '((compile-file clcs-compile-file)
	   (compile clcs-compile)
           (load clcs-load)
           (open clcs-open)
	   (si::break-level si::clcs-break-level)
	   (si::terminal-interrupt si::clcs-terminal-interrupt)
	   (si::break-quit si::clcs-break-quit)
	   (si::error-set clcs-error-set)
	   (si::universal-error-handler clcs-universal-error-handler))))
