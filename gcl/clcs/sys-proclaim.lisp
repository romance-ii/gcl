...
(PROCLAIM
    '(FTYPE (FUNCTION (T *) NIL) ERROR))
(PROCLAIM
    '(FTYPE (FUNCTION (SYMBOL T T *) T) CHECK-TYPE-INTERNAL))
(PROCLAIM
...
;(PROCLAIM '(FTYPE (FUNCTION (*) (si::returns-exactly)) INVOKE-DEBUGGER)) ;FIXME nil return types
...
(PROCLAIM
    '(FTYPE (FUNCTION (T *) *) CLCS-COMPILE-FILE CLCS-LOAD 
