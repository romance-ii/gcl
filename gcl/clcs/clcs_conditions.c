...
T23:;
	{register object V9;
	V9= CMPcar((V8));
	{object V10= CMPcar((V9));
	if((V10!= VV[51]))goto T29;
	if(!(type_of(CMPcadr((V9)))==t_string)){
	goto T32;}
	V6= list(4,VV[3],VV[4],VV[5],list(3,VV[6],CMPcadr((V9)),VV[7]));
	goto T30;
	goto T32;
T32:;
	V6= CMPcadr((V9));
...
T46:;
	...
	goto T41;
T41:;
	while(MMcdr(V13)!=Cnil)V13=MMcdr(V13);
...
static void LnkT55(){ call_or_link(VV[55],(void **)(void *)&Lnk55);} /* Defclass CONDITION2304 */
