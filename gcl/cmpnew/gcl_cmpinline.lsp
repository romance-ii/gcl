...
(defstruct (info (:print-function (lambda (x s i) (s-print 'info (info-type x) (si::address x) s)))
  ...
  (ref nil :type list)
  (ch  nil :type list)
  (vref-ccb nil :type list)
  (vref-clb nil :type list)
  (vref nil     :type list)
  (bref-ccb nil :type list)
  (bref-clb nil :type list)
  (bref nil     :type list)
  (tref-ccb nil :type list)
  (tref-clb nil :type list)
  (tref nil     :type list)
  (fref-ccb nil :type list)
;  (fref-clb nil :type list)
  (fref nil     :type list)
  )
