...
;; ;    NIL) 
;; (DEFSYSFUN 'TRUNCATE "Ltruncate" '(T *) '(RETURNS-EXACTLY INTEGER REAL) NIL NIL) 
;; ;(DEFSYSFUN 'TRUNCATE "Ltruncate" '(T *) '* NIL NIL) 
...
;; (DEFSYSFUN 'APPLYHOOK "Lapplyhook" '(T T T T *) '* NIL NIL) 
...
;; (DEFSYSFUN 'CEILING "Lceiling" '(T *) '(RETURNS-EXACTLY INTEGER REAL) NIL NIL) 
;; ;(DEFSYSFUN 'CEILING "Lceiling" '(T *) '* NIL NIL) 
;; (DEFSYSFUN 'GETHASH "Lgethash" '(T T *) '(RETURNS-EXACTLY T BOOLEAN) NIL NIL) 
;; ;(DEFSYSFUN 'GETHASH "Lgethash" '(T T *) '* NIL NIL) 
...
;; ;(DEFSYSFUN 'SYSTEM::CMOD "siLcmod" '(T) 'T NIL NIL) 
;; ;(DEFSYSFUN 'SYSTEM::CPLUS "siLcplus" '(T T) 'T NIL NIL) 
;; ;(DEFSYSFUN 'SYSTEM::CTIMES "siLctimes" '(T T) 'T NIL NIL) 
;; ;(DEFSYSFUN 'SYSTEM::CDIFFERENCE "siLcdifference" '(T T) 'T NIL NIL) 
...
;; ;(DEFSYSFUN 'READ-LINE "Lread_line" '(*) '* NIL NIL) 
...
;; ;(DEFSYSFUN 'INTERN "Lintern" '(T *) '* NIL NIL) 
...
;; (DEFSYSFUN 'PARSE-NAMESTRING "Lparse_namestring" '(T *) '(returns-exactly (or pathname (member nil)) seqind) NIL NIL) 
...
;; (DEFSYSFUN 'GET-MACRO-CHARACTER "Lget_macro_character" '(T *) '(values function boolean) NIL
;;     NIL) 
...
;; (DEFSYSFUN 'GET-PROPERTIES "Lget_properties" '(T T) '(returns-exactly t t list) NIL NIL) 
;; ;(DEFSYSFUN 'STRING<= "Lstring_le" '(T T *) 'T NIL NIL) 
;; (DEFSYSFUN 'EVALHOOK "Levalhook" '(T T T *) '* NIL NIL) 
...
;; (DEFSYSFUN 'FLOOR "Lfloor" '(T *) '(RETURNS-EXACTLY INTEGER REAL) NIL NIL) 
;; ;(DEFSYSFUN 'FLOOR "Lfloor" '(T *) '* NIL NIL) 
...
;; (DEFSYSFUN 'SYSTEM::FSET "siLfset" '(T T) NIL NIL NIL) 
;; (DEFSYSFUN 'SYSTEM::HASH-SET "siLhash_set" NIL T NIL NIL) 
;; ;(DEFSYSFUN 'BOOLE3 "Lboole" NIL T NIL NIL) 
;; (DEFSYSFUN 'SYSTEM::PACKAGE-INTERNAL "siLpackage_internal" '(T T) T NIL
;;     NIL) 
;; (DEFSYSFUN 'SYSTEM::PACKAGE-EXTERNAL "siLpackage_external" '(T T) T NIL
;;     NIL) 
...
;;     'CHARACTER NIL NIL) 
;; (DEFSYSFUN 'SYSTEM::MAKE-STRUCTURE "siLmake_structure" '(T *) T NIL NIL) 
