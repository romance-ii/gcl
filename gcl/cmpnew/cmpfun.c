...
goto TTL;
TTL:;
	if(((endp_prop(cddr((V186)))?Ct:Cnil))==Cnil){
	goto T651;}
	{object V187 = Cnil;
	VMR19(V187)}
goto T651;
T651:;
	if(endp_prop(cdddr((V186)))){
	goto T653;}
	{object V188 = Cnil;
	VMR19(V188)}
goto T653;
...
goto T775;
T775:;
	if(endp_prop(cddr((V257)))){
	goto T780;}
	if(endp_prop(cdddr((V257)))){
	goto T780;}
...
T965:;
	...
	{object cdr_V338=MMcdr(V338);while(!endp(cdr_V338)) {cdr_V338=MMcdr(cdr_V338);V338=MMcdr(V338);}}
	V339=MMcdr(V339);
	if(endp(V339)){
...
goto TTL;
TTL:;
	if(((endp_prop((V372))?Ct:Cnil))==Cnil){
	goto T1006;}
	{object V373 = Cnil;
	VMR39(V373)}
goto T1006;
T1006:;
	if(((endp_prop(cdr((V372)))?Ct:Cnil))==Cnil){
	goto T1008;}
	{object V374 = Cnil;
	VMR39(V374)}
goto T1008;
T1008:;
	if(endp_prop(cddr((V372)))){
	goto T1010;}
	{object V375 = Cnil;
	VMR39(V375)}
goto T1010;
...
goto TTL;
TTL:;
	if(((endp_prop((V385))?Ct:Cnil))==Cnil){
	goto T1026;}
	{object V386 = Cnil;
	VMR41(V386)}
goto T1026;
T1026:;
	if(((endp_prop(cdr((V385)))?Ct:Cnil))==Cnil){
	goto T1028;}
	{object V387 = Cnil;
	VMR41(V387)}
goto T1028;
T1028:;
	if(endp_prop(cddr((V385)))){
	goto T1030;}
	{object V388 = Cnil;
	VMR41(V388)}
goto T1030;
...
TTL:;
	...
	if(endp_prop((V398))){
	goto T1048;}
	if(endp_prop(cdr((V398)))){
	goto T1048;}
	if(!(endp_prop(cddr((V398))))){
	goto T1047;}
goto T1048;
T1048:;
