...
(PROCLAIM
    '(FTYPE (FUNCTION (T (ARRAY T (*)) SEQIND SEQIND T) FIXNUM)
            BSEARCHLEQ)) 
(PROCLAIM
    '(FTYPE (FUNCTION (T T T) T)  do-setq-tp cons-tp-limit ASSIGN-DOWN-VARS TOO-FEW-ARGS
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) T) set-var-init-type CMP-NTHCDR COMPILER-CLEAR-COMPILER-PROPERTIES
