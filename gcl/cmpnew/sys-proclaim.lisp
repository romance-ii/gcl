...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) FIXNUM) PROCLAIMED-ARGD ANALYZE-REGS1
            ANALYZE-REGS)) 
(PROCLAIM
    '(FTYPE (FUNCTION ((VECTOR STRING-CHAR)) T) DASH-TO-UNDERSCORE)) 
...
(PROCLAIM
    '(FTYPE (FUNCTION ((VECTOR STRING-CHAR) FIXNUM FIXNUM) T)
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T *) T) DO-VECTOR-MAP DO-SEQUENCE-SEARCH
            DO-LIST-SEARCH SUPER-RANGE C2LAMBDA-EXPR INLINE-ARGS
...
(PROCLAIM
    '(FTYPE (FUNCTION (T (ARRAY T (*)) SEQIND SEQIND T) FIXNUM)
            BSEARCHLEQ)) 
(PROCLAIM
    '(FTYPE (FUNCTION (T T T) T) ASSIGN-DOWN-VARS TOO-FEW-ARGS
            ...
            C1MAP-FUNCTIONS CAN-BE-REPLACED* DECLARE-LET-BINDINGS-NEW
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T T T T T) T) T3DEFMACRO T2DEFMACRO DEFSYSFUN)) 
(PROCLAIM
...
(PROCLAIM
    '(FTYPE (FUNCTION (*) T) CS-PUSH FCALLN-INLINE MAKE-VAR
            ...
            WT-C-PUSH)) 
(PROCLAIM
    '(FTYPE (FUNCTION (T) T) SCH-GLOBAL COERCE-TO-INTEGER-TYPE T3CLINES
            ...
            CMP-MACROEXPAND PROMOTED-C-TYPE OBJECT-TYPE INTEGER-TYPEP
...
(PROCLAIM
    '(FTYPE (FUNCTION (T *) T) CMPNOTE CMPWARN CMPERR INTEGER-NORM-FORM
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) T) COMPILER-CLEAR-COMPILER-PROPERTIES
            ...
            C2SETQ C1SETQ1 INTEGER-TYPE-AND TYPE>= TYPE-AND TYPE<=
