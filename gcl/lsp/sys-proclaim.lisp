...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) FIXNUM) GET-NODE-INDEX RELATIVE-LINE
            THE-END)) 
(PROCLAIM
    '(FTYPE (FUNCTION ((VECTOR STRING-CHAR)) T) COERCE-SLASH-TERMINATED
            RESET-SYS-PATHS)) 
(PROCLAIM
    '(FTYPE (FUNCTION ((VECTOR STRING-CHAR) *) *) GET-COMMAND-ARG)) 
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T T T) T) SLOOP::FIRST-SLOOP-FOR
...
(PROCLAIM
    '(FTYPE (FUNCTION NIL *) BREAK-CURRENT BREAK-MESSAGE
            SIMPLE-BACKTRACE)) 
(PROCLAIM
    '(FTYPE (FUNCTION ((VECTOR STRING-CHAR) FIXNUM) FIXNUM) ATOI)) 
(PROCLAIM
...
(PROCLAIM
    '(FTYPE (FUNCTION (*) T) COPY-PPRINT-DISPATCH DBL-READ BREAK
...
(PROCLAIM
    '(FTYPE (FUNCTION (T) T) FUNCTION-P DO-F SLOOP::POINTER-FOR-COLLECT
            ...
            SERROR:ERROR-NAME NRECONSTRUCT-TYPE INTERPRETED-FUNCTION-P
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) T) copy-type SLOOP::LOGXOR-SLOOP-COLLECT
