...
TTL:;
	...
	{object V220;
	V220= (
	(type_of((V219)) == t_sfun ?(*(((V219))->sfn.sfn_self)):
...
T1034:;
	...
	V371= make_fixnum((long)length((V364)));
	V372= small_fixnum(0);
goto T1041;
T1041:;
...
T1068:;
	...
	V389 = make_fixnum((long)length((V383)));
	V387= one_minus(V389);
	V388= small_fixnum(0);
goto T1077;
T1077:;
...
T1125:;
	...
	if((V408)==Cnil){
	goto T1135;}
	V411 = make_fixnum((long)length((V404)));
...
T1135:;
	if((V409)==Cnil){
	goto T1139;}
	V412 = make_fixnum((long)length((V404)));
