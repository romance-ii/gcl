...
T163:;
	...
	{object V100;
	object V101;
	V100= make_fixnum((long)length((V98)));
	base[32]= VV[61];
...
T494:;
	...
	vs_top=sup;
	V175= fix(vs_base[0]);
	base[2]= make_fixnum((long)(fix((V172)))+(V175));
	vs_top=(vs_base=base+2)+1;
	return;
goto T506;
T506:;
...
T515:;
	...
	vs_top=sup;
	V178= fix(vs_base[0]);
	base[2]= make_fixnum((long)(/* INLINE-ARGS */V177)+(V178));
	vs_top=(vs_base=base+2)+1;
	return;}
goto T513;
T513:;
...
T585:;
	if(!(((V171))==(VV[85]))){
	goto T596;}
	{long V186= (long)length(cadr((V168)));
	base[2]= cddr((V168));
	vs_top=(vs_base=base+2)+1;
	L40(base);
	vs_top=sup;
	V187= fix(vs_base[0]);
	base[2]= make_fixnum((long)(/* INLINE-ARGS */V186)+(V187));
	vs_top=(vs_base=base+2)+1;
	return;}
goto T596;
T596:;
...
T620:;
	...
	vs_top=sup;
	V192= fix(vs_base[0]);
	base[2]= make_fixnum((long)(3)+(V192));
	vs_top=(vs_base=base+2)+1;
	return;}}
goto T497;
T497:;
...
goto T1826;
T1826:;
	V486 = make_fixnum((long)length((V476)));
...
T2189:;
	...
	V554= (
	V557 = V556,
	(type_of(V557) == t_sfun ?(*((V557)->sfn.sfn_self)):
...
TTL:;
	{object V695;
	object V696;
	V695= make_fixnum((long)length((V694)));
	base[3]= VV[61];
