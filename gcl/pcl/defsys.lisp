...
;  (rel-7-1-patches t            t            ()                rel-7-1)
   ...
   (pcl_walk        (pcl_pkg)    (pcl_pkg)    ())
   (pcl_iterate     t            t            ())
   (pcl_macros      t            t            ())
   (pcl_low         (pcl_pkg pcl_macros) t            (pcl_macros))
   
   
   (genera-low     (pcl_low)         (pcl_low)        (pcl_low)            Genera)
   (cloe-low	   (pcl_low)	     (pcl_low)	      (pcl_low)            Cloe)
   (lucid-low      (pcl_low)         (pcl_low)        (pcl_low)            Lucid)
   (Xerox-low      (pcl_low)         (pcl_low)        (pcl_low)            Xerox)
   (ti-low         (pcl_low)         (pcl_low)        (pcl_low)            TI)
   (vaxl-low       (pcl_low)         (pcl_low)        (pcl_low)            vaxlisp)
   (kcl-low        (pcl_low)         (pcl_low)        (pcl_low)            KCL)
   (ibcl-low       (pcl_low)         (pcl_low)        (pcl_low)            IBCL)
   (pcl_gcl_low    (pcl_low)         (pcl_low)        (pcl_low)            gcl)
   (excl-low       (pcl_low)         (pcl_low)        (pcl_low)            excl)
   (cmu-low        (pcl_low)         (pcl_low)        (pcl_low)            CMU)
   (hp-low         (pcl_low)         (pcl_low)        (pcl_low)            HP-HPLabs)
   (gold-low       (pcl_low)         (pcl_low)        (pcl_low)            gclisp) 
   (pyr-low        (pcl_low)         (pcl_low)        (pcl_low)            pyramid) 
   (coral-low      (pcl_low)         (pcl_low)        (pcl_low)            coral)
   
   (pcl_fin         t                                   t (pcl_low))
   (pcl_defclass    t                                   t (pcl_low))
   (pcl_defs        t                                   t (pcl_defclass pcl_macros pcl_iterate))
   (pcl_fngen       t                                   t (pcl_low))
   (pcl_cache       t                                   t (pcl_low pcl_defs))
   (pcl_dlisp       t                                   t (pcl_defs pcl_low pcl_fin pcl_cache))
   (pcl_dlisp2      t                                   t (pcl_low pcl_fin pcl_cache pcl_dlisp))
   (pcl_boot        t                                   t (pcl_defs pcl_fin))
   (pcl_vector      t                                   t (pcl_boot pcl_defs pcl_cache pcl_fin))
   (pcl_slots_boot  t                                   t (pcl_vector pcl_boot pcl_defs pcl_cache pcl_fin))
   (pcl_combin      t                                   t (pcl_boot pcl_defs))
   (pcl_dfun        t                                   t (pcl_boot pcl_low pcl_cache))
   (pcl_fast_init   t                                   t (pcl_boot pcl_low))
   (pcl_braid       (+ pcl_precom1 pcl_precom2)         t (pcl_boot pcl_defs pcl_low pcl_fin pcl_cache))
   (pcl_generic_functions t                             t (pcl_boot))
   (pcl_slots       t                                   t (pcl_vector pcl_boot pcl_defs pcl_low pcl_cache pcl_fin))
   (pcl_init        t                                   t (pcl_vector pcl_boot pcl_defs pcl_low pcl_fast_init))
   (pcl_std_class   t                                   t (pcl_vector pcl_boot pcl_defs pcl_low pcl_cache pcl_fin pcl_slots))
   (pcl_cpl         t                                   t (pcl_vector pcl_boot pcl_defs pcl_low pcl_cache pcl_fin pcl_slots))
   (pcl_fsc         t                                   t (pcl_defclass pcl_boot pcl_defs pcl_low pcl_fin pcl_cache))
   (pcl_methods     t                                   t (pcl_defclass pcl_boot pcl_defs pcl_low pcl_fin pcl_cache))
   (pcl_fixup       t                                   t (pcl_boot pcl_defs pcl_low pcl_fin))
   (pcl_defcombin   t                                   t (pcl_defclass pcl_boot pcl_defs pcl_low pcl_fin))
   (pcl_ctypes      t                                   t (pcl_defclass pcl_defcombin))
   (pcl_env         t                                   t (pcl_defclass pcl_boot pcl_defs pcl_low pcl_fin))
   (pcl_compat      t                                   t ())
   (pcl_precom1     (pcl_dlisp)                         t (pcl_defs pcl_low pcl_cache pcl_fin pcl_dfun))
   (pcl_precom2     (pcl_dlisp)                         t (pcl_defs pcl_low pcl_cache pcl_fin pcl_dfun))
   ))
