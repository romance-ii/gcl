...
(PROCLAIM
    '(FTYPE (FUNCTION (T T *) *) GET-EFFECTIVE-METHOD-FUNCTION
            MAKE-N-N-ACCESSOR-DFUN MAKE-CHECKING-DFUN LOAD-DEFGENERIC
            TYPES-FROM-ARGUMENTS MAKE-DEFAULT-INITARGS-FORM-LIST
            MAKE-FINAL-ACCESSOR-DFUN MAKE-ACCESSOR-TABLE
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T T) *) OPTIMIZE-SLOT-VALUE-BY-CLASS-P
            ACCESSOR-VALUES1 EMIT-READER/WRITER
            EMIT-ONE-OR-N-INDEX-READER/WRITER GENERATING-LISP
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T T *) T) REAL-GET-METHOD CHECK-INITARGS-1
            ...
            WALKER::WALK-ARGLIST MAKE-EMF-CALL CAN-OPTIMIZE-ACCESS1
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T T) T) DECLARE-STRUCTURE OPTIMIZE-SLOT-BOUNDP
            PRINT-CACHE FIRST-FORM-TO-LISP
            ...
            FLUSH-CACHE-TRAP COMPUTE-EFFECTIVE-METHOD
            SET-FUNCTION-NAME-1 OBSOLETE-INSTANCE-TRAP
            ...
            SORT-APPLICABLE-METHODS SORT-METHODS VARIABLE-DECLARATION
...
(PROCLAIM
    '(FTYPE (FUNCTION NIL T) MAKE-CACHE IN-THE-COMPILER-P
            STRUCTURE-FUNCTIONS-EXIST-P ALLOCATE-FUNCALLABLE-INSTANCE-2
            %%ALLOCATE-INSTANCE--CLASS ALLOCATE-FUNCALLABLE-INSTANCE-1
            DISPATCH-DFUN-INFO INITIAL-DISPATCH-DFUN-INFO
            INITIAL-DFUN-INFO NO-METHODS-DFUN-INFO
            SHOW-FREE-CACHE-VECTORS MAKE-CPD MAKE-ARG-INFO
            SHOW-DFUN-CONSTRUCTORS RENEW-SYS-FILES
            ...
            CACHES-TO-ALLOCATE UPDATE-DISPATCH-DFUNS)) 
...
(PROCLAIM
    '(FTYPE (FUNCTION (T) T) CLASS-OF CHECK-CACHE DISPATCH-CACHE
            CLASS-FROM-TYPE DEFAULT-METHOD-ONLY-CACHE DNET-METHODS-P
            ACCESSOR-DFUN-INFO-CACHE METHOD-FUNCTION-FROM-FAST-FUNCTION
            INTERN-EQL-SPECIALIZER ONE-INDEX-DFUN-INFO-CACHE
            ONE-INDEX-DFUN-INFO-ACCESSOR-TYPE
            METHOD-CALL-CALL-METHOD-ARGS KEYWORD-SPEC-NAME N-N-CACHE
            EXTRACT-LAMBDA-LIST GENERIC-CLOBBERS-FUNCTION
            N-N-ACCESSOR-TYPE DEFAULT-CONSTANT-CONVERTER
            FAST-METHOD-CALL-PV-CELL WRAPPER-FOR-STRUCTURE
            ONE-CLASS-CACHE FAST-METHOD-CALL-NEXT-METHOD-CALL
            ONE-CLASS-ACCESSOR-TYPE ONE-CLASS-INDEX BUILT-IN-WRAPPER-OF
            TWO-CLASS-CACHE BUILT-IN-OR-STRUCTURE-WRAPPER1
            WALKER::GET-WALKER-TEMPLATE TWO-CLASS-ACCESSOR-TYPE
            TWO-CLASS-INDEX GET-MAKE-INSTANCE-FUNCTION-SYMBOL
            ALLOCATE-CACHE-VECTOR TWO-CLASS-WRAPPER0
            FLUSH-CACHE-VECTOR-INTERNAL COMPUTE-LINE-SIZE
            EXTRACT-SPECIALIZER-NAMES ONE-INDEX-CACHE
            ...
            ONE-INDEX-INDEX INTERN-FUNCTION-NAME GF-LAMBDA-LIST
            CHECKING-P CHECKING-CACHE CACHING-CACHE EARLY-CLASS-SLOTS
            CONSTANT-VALUE-CACHE GF-INFO-C-A-M-EMF-STD-P
            COMPILE-LAMBDA-DEFERRED STRUCTURE-TYPE-INTERNAL-SLOTDS
            FUNCALLABLE-INSTANCE-P GF-INFO-FAST-MF-P SHOW-DFUN-COSTS
            UNDEFMETHOD-1 RESET-CLASS-INITIALIZE-INFO
            METHOD-LL->GENERIC-FUNCTION-LL EARLY-COLLECT-CPL
            GET-CACHE-VECTOR EARLY-COLLECT-SLOTS CONSTANT-SYMBOL-P
            ARG-INFO-P FREE-CACHE-VECTOR EARLY-METHOD-LAMBDA-LIST
            FAST-METHOD-CALL-ARG-INFO ARG-INFO-VALID-P
            ...
            ACCESSOR-DFUN-INFO-ACCESSOR-TYPE PARSE-SPECIALIZERS
            ECD-CANONICAL-SLOTS RESET-INITIALIZE-INFO EVAL-FORM
            ...
            BOOTSTRAP-CLASS-PREDICATES DEFAULT-STRUCTURE-INSTANCE-P
            GET-BUILT-IN-CLASS-SYMBOL DEFAULT-STRUCTURE-TYPE
            INITIALIZE-INFO-WRAPPER STRUCTURE-TYPE
            GET-BUILT-IN-WRAPPER-SYMBOL COMPUTE-STD-CPL-PHASE-2
            DO-STANDARD-DEFSETF-1 GET-PV-CELL-FOR-CLASS CACHING-P
            STRUCTURE-TYPE-INCLUDED-TYPE-NAME GFS-OF-TYPE
            STRUCTURE-TYPE-SLOT-DESCRIPTION-LIST LEGAL-CLASS-NAME-P
            CACHE-P STRUCTURE-TYPE-P STRUCTURE-SLOTD-NAME
            CONSTANT-VALUE-P STRUCTURE-SLOTD-ACCESSOR-SYMBOL
            USE-DEFAULT-METHOD-ONLY-DFUN-P SFUN-P
            INITIALIZE-INFO-CACHED-COMBINED-INITARGS-FORM-LIST
            DEFAULT-SECONDARY-DISPATCH-FUNCTION WRAPPER-FIELD
            STRUCTURE-SLOTD-WRITER-FUNCTION NEXT-WRAPPER-FIELD
            FIND-CYCLE-REASONS SETFBOUNDP EARLY-CLASS-DEFINITION
            GET-SETF-FUNCTION-NAME ECD-SOURCE
            VARIABLE-GLOBALLY-SPECIAL-P USE-CACHING-DFUN-P
            STRUCTURE-SLOTD-TYPE MAKE-PV-TYPE-DECLARATION
            FORMAT-CYCLE-REASONS MAKE-CALLS-TYPE-DECLARATION
            ECD-METACLASS MAP-SPECIALIZERS SYSTEM:%STRUCTURE-NAME
            CPD-CLASS SLOT-VECTOR-SYMBOL EARLY-CLASS-PRECEDENCE-LIST
            MAKE-PERMUTATION-VECTOR SYSTEM:%COMPILED-FUNCTION-NAME
            METHODS-CONTAIN-EQL-SPECIALIZER-P STRUCTURE-OBJECT-P
            MAKE-TYPE-PREDICATE EXPAND-MAKE-INSTANCE-FORM CPD-SUPERS
            MAKE-CONSTANT-FUNCTION DEFAULT-TEST-CONVERTER
            FUNCTION-RETURNING-T EXPAND-LONG-DEFCOMBIN SORT-SLOTS
            INITIAL-P SORT-CALLS EARLY-CLASS-NAME-OF SYMBOL-PKG-NAME
            FORCE-CACHE-FLUSHES
            CLASS-HAS-A-FORWARD-REFERENCED-SUPERCLASS-P CPD-AFTER
            INITIALIZE-INFO-BOUND-SLOTS EARLY-CLASS-SLOTDS
            INITIALIZE-INFO-CACHED-VALID-P INITIAL-DISPATCH-P
            GET-MAKE-INSTANCE-FUNCTIONS DISPATCH-P
...
(PROCLAIM
    '(FTYPE (FUNCTION (T *) *) ENSURE-GENERIC-FUNCTION ENSURE-CLASS
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) *) *SUBTYPEP ITERATE::PARSE-DECLARATIONS
            ...
            CHECK-INITARGS-VALUES SAUT-EQL INSURE-DFUN)) 
(PROCLAIM
    '(FTYPE (FUNCTION (T *) T) FIND-CLASS CAPITALIZE-WORDS
            ...
            MAKE-WRAPPER)) 
(PROCLAIM
    '(FTYPE (FUNCTION (T T) T) DO-SATISFIES-DEFTYPE
            ...
            MAKE-CDXR CHECKING-DFUN-INFO MAKE-PV-TABLE-INTERNAL
            ...
            PV-WRAPPERS-FROM-ALL-ARGS PV-TABLE-LOOKUP UPDATE-CPL
            UPDATE-SLOTS PROCLAIM-DEFGENERIC UPDATE-INITS LIST-EQ
            ...
            REMOVE-METHOD REDEFINE-FUNCTION METHODS-CONVERTER
            ADD-METHOD PV-WRAPPERS-FROM-ALL-WRAPPERS
            NET-CONSTANT-CONVERTER AUGMENT-TYPE CHANGE-CLASS-INTERNAL
            VALUE-FOR-CACHING |SETF PCL METHOD-FUNCTION-PLIST|
            GET-KEY-ARG GET-KEY-ARG1 SET-METHODS
            SET-FUNCTION-PRETTY-ARGLIST FIND-STANDARD-II-METHOD
            SET-FUNCALLABLE-INSTANCE-FUNCTION MAKE-EARLY-ACCESSOR
            ...
            SLOT-EXISTS-P SWAP-WRAPPERS-AND-SLOTS ITERATE::MV-SETQ
            ...
            RAISE-METATYPE VARIABLE-SPECIAL-P STANDARD-INSTANCE-ACCESS
